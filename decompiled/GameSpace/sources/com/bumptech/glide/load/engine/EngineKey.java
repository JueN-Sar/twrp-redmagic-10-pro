...
class EngineKey implements Key {
    ...
    public String toString() {
        if (this.stringKey == null) {
            StringBuilder append = new StringBuilder("EngineKey{").append(this.id).append('+').append(this.signature).append("+[").append(this.width).append('x').append(this.height).append("]+'");
            ResourceDecoder resourceDecoder = this.cacheDecoder;
            StringBuilder append2 = append.append(resourceDecoder != null ? resourceDecoder.getId() : "").append("'+'");
            ResourceDecoder resourceDecoder2 = this.decoder;
            StringBuilder append3 = append2.append(resourceDecoder2 != null ? resourceDecoder2.getId() : "").append("'+'");
            Transformation transformation = this.transformation;
            StringBuilder append4 = append3.append(transformation != null ? transformation.getId() : "").append("'+'");
            ResourceEncoder resourceEncoder = this.encoder;
            StringBuilder append5 = append4.append(resourceEncoder != null ? resourceEncoder.getId() : "").append("'+'");
            ResourceTranscoder resourceTranscoder = this.transcoder;
            StringBuilder append6 = append5.append(resourceTranscoder != null ? resourceTranscoder.getId() : "").append("'+'");
            Encoder encoder = this.sourceEncoder;
            this.stringKey = append6.append(encoder != null ? encoder.getId() : "").append("'}").toString();
        }
