...
public abstract class CaseFormat {
    ...
    static {
        ...
        LOWER_UNDERSCORE = new CaseFormat("LOWER_UNDERSCORE", 1, CharMatcher.is('_'), str) { // from class: com.google.common.base.CaseFormat.2
            ...
            String convert(CaseFormat caseFormat, String str2) {
                return caseFormat == LOWER_HYPHEN ? str2.replace('_', '-') : caseFormat == UPPER_UNDERSCORE ? Ascii.toUpperCase(str2) : super.convert(caseFormat, str2);
            }
        ...
        UPPER_UNDERSCORE = new CaseFormat("UPPER_UNDERSCORE", 4, CharMatcher.is('_'), str) { // from class: com.google.common.base.CaseFormat.5
            ...
            String convert(CaseFormat caseFormat, String str3) {
                return caseFormat == LOWER_HYPHEN ? Ascii.toLowerCase(str3.replace('_', '-')) : caseFormat == LOWER_UNDERSCORE ? Ascii.toLowerCase(str3) : super.convert(caseFormat, str3);
            }
    ...
    String convert(CaseFormat caseFormat, String str) {
        ...
        return i == 0 ? caseFormat.normalizeFirstWord(str) : ((StringBuilder) java.util.Objects.requireNonNull(sb)).append(caseFormat.normalizeWord(str.substring(i))).toString();
    }
