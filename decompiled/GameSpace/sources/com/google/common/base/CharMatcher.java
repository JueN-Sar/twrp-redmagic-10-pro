...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(this, precomputedPositive(i, bitSet, charMatcher.endsWith(".negate()") ? charMatcher.substring(0, charMatcher.length() - 9) : charMatcher + ".negate()")) { // from class: com.google.common.base.CharMatcher.1
