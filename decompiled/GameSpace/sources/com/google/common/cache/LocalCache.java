...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        /* synthetic */ Object m414x59597480(Object obj) {
            set(obj);
            return obj;
        }
        ...
        public ListenableFuture<V> loadFuture(K k, CacheLoader<? super K, V> cacheLoader) {
            try {
                ...
                return reload == null ? Futures.immediateFuture(null) : Futures.transform(reload, new Function() { // from class: com.google.common.cache.LocalCache$LoadingValueReference$$ExternalSyntheticLambda0
                    @Override // com.google.common.base.Function
                    public final Object apply(Object obj) {
                        return LocalCache.LoadingValueReference.this.m414x59597480(obj);
                    }
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        /* synthetic */ void m415lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(Object obj, int i, LoadingValueReference loadingValueReference, ListenableFuture listenableFuture) {
            try {
        ...
        ListenableFuture<V> loadAsync(final K k, final int i, final LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> cacheLoader) {
            ...
            loadFuture.addListener(new Runnable() { // from class: com.google.common.cache.LocalCache$Segment$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    LocalCache.Segment.this.m415lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(k, i, loadingValueReference, loadFuture);
                }
            }, MoreExecutors.directExecutor());
            return loadFuture;
        }
