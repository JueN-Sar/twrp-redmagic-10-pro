...
public final class IntMath {
    ...
    static final int[] powersOf10 = {1, 10, 100, 1000, 10000, AacUtil.AAC_LC_MAX_RATE_BYTES_PER_SECOND, 1000000, 10000000, 100000000, Utils.SECOND_IN_NANOS};
    ...
    public static int gcd(int i, int i2) {
        ...
        MathPreconditions.checkNonNegative(GameSpaceConfig.SUPPORT_FAN, i2);
        if (i == 0) {
            return i2;
        }
        if (i2 == 0) {
