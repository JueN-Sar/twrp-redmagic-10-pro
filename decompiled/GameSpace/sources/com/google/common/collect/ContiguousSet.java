...
public abstract class ContiguousSet<C extends Comparable> extends ImmutableSortedSet<C> {
    ...
    public static <C extends Comparable> ContiguousSet<C> create(Range<C> range, DiscreteDomain<C> discreteDomain) {
        ...
        try {
            ...
            return (!intersection.isEmpty() && Range.compareOrThrow((Comparable) Objects.requireNonNull(range.lowerBound.leastValueAbove(discreteDomain)), (Comparable) Objects.requireNonNull(range.upperBound.greatestValueBelow(discreteDomain))) <= 0) ? new RegularContiguousSet(intersection, discreteDomain) : new EmptyContiguousSet(discreteDomain);
