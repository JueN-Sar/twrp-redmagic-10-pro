    ...
    public static class Builder<K, V> {
        ...
        static final class DuplicateKey {
            ...
            IllegalArgumentException exception() {
                return new IllegalArgumentException("Multiple entries with same key: " + this.key + ApiSignUtil.CONNECTOR_TAG + this.value1 + " and " + this.key + ApiSignUtil.CONNECTOR_TAG + this.value2);
            }
        }
