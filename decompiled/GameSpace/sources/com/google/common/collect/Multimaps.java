...
public final class Multimaps {
    ...
    private static final class TransformedEntriesListMultimap<K, V1, V2> extends TransformedEntriesMultimap<K, V1, V2> implements ListMultimap<K, V2> {
        ...
        public List<V2> get(@ParametricNullness K k) {
            return m417x893217c0((TransformedEntriesListMultimap<K, V1, V2>) k, (Collection) this.fromMultimap.get(k));
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // com.google.common.collect.Multimaps.TransformedEntriesMultimap, com.google.common.collect.Multimap, com.google.common.collect.ListMultimap
        public List<V2> removeAll(@CheckForNull Object obj) {
            return m417x893217c0((TransformedEntriesListMultimap<K, V1, V2>) obj, (Collection) this.fromMultimap.removeAll(obj));
        }
        ...
        /* bridge */ /* synthetic */ Collection m417x893217c0(@ParametricNullness Object obj, Collection collection) {
            return m417x893217c0((TransformedEntriesListMultimap<K, V1, V2>) obj, collection);
        }

        @Override // com.google.common.collect.Multimaps.TransformedEntriesMultimap
        /* renamed from: transform */
        List<V2> m417x893217c0(@ParametricNullness K k, Collection<V1> collection) {
    ...
    static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        Map<K, Collection<V2>> createAsMap() {
            return Maps.transformEntries(this.fromMultimap.asMap(), new Maps.EntryTransformer() { // from class: com.google.common.collect.Multimaps$TransformedEntriesMultimap$$ExternalSyntheticLambda0
                ...
                public final Object transformEntry(Object obj, Object obj2) {
                    return Multimaps.TransformedEntriesMultimap.this.m417x893217c0(obj, (Collection) obj2);
                }
            });
        }
        ...
        public Collection<V2> get(@ParametricNullness K k) {
            return m417x893217c0(k, this.fromMultimap.get(k));
        }
        ...
        public Collection<V2> removeAll(@CheckForNull Object obj) {
            return m417x893217c0(obj, this.fromMultimap.removeAll(obj));
        }
        ...
        public Collection<V2> m417x893217c0(@ParametricNullness K k, Collection<V1> collection) {
