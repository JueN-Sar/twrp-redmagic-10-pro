...
class Subscriber {
    ...
    final void dispatchEvent(final Object obj) {
        this.executor.execute(new Runnable() { // from class: com.google.common.eventbus.Subscriber$$ExternalSyntheticLambda0
            ...
            public final void run() {
                Subscriber.this.m418lambda$dispatchEvent$0$comgooglecommoneventbusSubscriber(obj);
            }
        });
    }
    ...
    /* synthetic */ void m418lambda$dispatchEvent$0$comgooglecommoneventbusSubscriber(Object obj) {
        try {
