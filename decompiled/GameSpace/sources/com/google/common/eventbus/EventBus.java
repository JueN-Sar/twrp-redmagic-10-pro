...
public class EventBus {
    ...
    public EventBus() {
        this(SuperResolutionHelper.DEFAULT_SUPPORT);
    }

    public EventBus(SubscriberExceptionHandler subscriberExceptionHandler) {
        this(SuperResolutionHelper.DEFAULT_SUPPORT, MoreExecutors.directExecutor(), Dispatcher.perThreadDispatchQueue(), subscriberExceptionHandler);
    }
