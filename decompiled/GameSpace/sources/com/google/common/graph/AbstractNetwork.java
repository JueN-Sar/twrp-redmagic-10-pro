...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    class AnonymousClass1 extends AbstractGraph<N> {
        ...
        class C00321 extends AbstractSet<EndpointPair<N>> {
            C00321() {
            }
            ...
            public Iterator<EndpointPair<N>> iterator() {
                return Iterators.transform(AbstractNetwork.this.edges().iterator(), new Function() { // from class: com.google.common.graph.AbstractNetwork$1$1$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return AbstractNetwork.AnonymousClass1.C00321.this.m422lambda$iterator$0$comgooglecommongraphAbstractNetwork$1$1(obj);
                    }
                });
            }

            /* renamed from: lambda$iterator$0$com-google-common-graph-AbstractNetwork$1$1, reason: not valid java name */
            /* synthetic */ EndpointPair m422lambda$iterator$0$comgooglecommongraphAbstractNetwork$1$1(Object obj) {
        ...
        public Set<EndpointPair<N>> edges() {
            return AbstractNetwork.this.allowsParallelEdges() ? super.edges() : new C00321();
        }
