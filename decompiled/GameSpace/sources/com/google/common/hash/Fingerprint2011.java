...
final class Fingerprint2011 extends AbstractNonStreamingHashFunction {
    ...
    static long fingerprint(byte[] bArr, int i, int i2) {
        long murmurHash64WithSeed = i2 <= 32 ? murmurHash64WithSeed(bArr, i, i2, -1397348546323613475L) : i2 <= 64 ? hashLength33To64(bArr, i, i2) : fullFingerprint(bArr, i, i2);
        long j = K0;
        long load64 = i2 >= 8 ? LittleEndianByteArray.load64(bArr, i) : -6505348102511208375L;
        if (i2 >= 9) {
            j = LittleEndianByteArray.load64(bArr, (i + i2) - 8);
        }
        long hash128to64 = hash128to64(murmurHash64WithSeed + j, load64);
