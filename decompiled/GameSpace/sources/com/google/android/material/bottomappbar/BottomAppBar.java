...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    */
    ...
    private void createFabTranslationXAnimation(int i, List<Animator> list) {
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(findDependentFab(), AnimatorHelper.Item.TRANSLATIONX, getFabTranslationX(i));
    ...
    private void createMenuViewTranslationAnimation(final int i, final boolean z, List<Animator> list) {
        ...
        Animator ofFloat = ObjectAnimator.ofFloat(actionMenuView, AnimatorHelper.Item.ALPHA, 1.0f);
        ...
        if (Math.abs(actionMenuView.getTranslationX() - getActionMenuViewTranslationX(actionMenuView, i, z)) <= 1.0f) {
            ...
            ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(actionMenuView, AnimatorHelper.Item.ALPHA, 0.0f);
