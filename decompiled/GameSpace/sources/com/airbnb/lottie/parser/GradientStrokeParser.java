...
class GradientStrokeParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.of("nm", GameSpaceConfig.SUPPORT_WECHAT_SHORTCUT, "o", "t", CmcdData.Factory.STREAMING_FORMAT_SS, GameSpaceConfig.SUPPORT_NEWS, "w", "lc", "lj", "ml", "hd", "d");
                ...
                case 11:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (str3.equals("o")) {
                            ...
                            if (str3.equals("d") || str3.equals(GameSpaceConfig.SUPPORT_WECHAT_SHORTCUT)) {
