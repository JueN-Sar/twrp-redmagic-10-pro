...
public class LottieAnimationView extends AppCompatImageView {
    ...
    private LottieTask<LottieComposition> fromAssets(final String str) {
        return isInEditMode() ? new LottieTask<>(new Callable() { // from class: com.airbnb.lottie.LottieAnimationView$$ExternalSyntheticLambda1
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return LottieAnimationView.this.m340lambda$fromAssets$2$comairbnblottieLottieAnimationView(str);
            }
    ...
    private LottieTask<LottieComposition> fromRawRes(final int i) {
        return isInEditMode() ? new LottieTask<>(new Callable() { // from class: com.airbnb.lottie.LottieAnimationView$$ExternalSyntheticLambda3
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return LottieAnimationView.this.m341lambda$fromRawRes$1$comairbnblottieLottieAnimationView(i);
            }
    ...
    /* synthetic */ LottieResult m340lambda$fromAssets$2$comairbnblottieLottieAnimationView(String str) throws Exception {
    ...
    /* synthetic */ LottieResult m341lambda$fromRawRes$1$comairbnblottieLottieAnimationView(int i) throws Exception {
