...
public class TaskStack {
    ...
    private final FilteredTaskList mStackTaskList;
    ...
    public TaskStack() {
        ...
        filteredTaskList.setFilter(new TaskFilter() { // from class: com.android.systemui.shared.recents.model.TaskStack$$ExternalSyntheticLambda0
    ...
    public Task getNextLaunchTarget() {
        ...
        return nextLaunchTargetRaw != null ? nextLaunchTargetRaw : getTasks().get(getTaskCount() - 1);
    }
    ...
    public void removeAllTasks(boolean z, boolean z2) {
        ...
        for (int size = tasks.size() - 1; size >= 0; size--) {
            Task task = tasks.get(size);
            if (!task.isSafetyCleanLocked && (z2 || getLaunchTarget() != task)) {
                this.mStackTaskList.remove(task);
                this.mRawTaskList.remove(task);
            }
        }
