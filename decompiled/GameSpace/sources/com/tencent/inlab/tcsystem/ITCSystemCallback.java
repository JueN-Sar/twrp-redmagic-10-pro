...
public interface ITCSystemCallback extends IInterface {
    ...
    public static class Default implements ITCSystemCallback {
        ...
        public String onEventNotify(byte[] bArr) throws RemoteException {
            return null;
        }

        @Override // com.tencent.inlab.tcsystem.ITCSystemCallback
        public String onStreamNotify(byte[] bArr, String str) throws RemoteException {
            return null;
        }
    }
    ...
    String onEventNotify(byte[] bArr) throws RemoteException;

    String onStreamNotify(byte[] bArr, String str) throws RemoteException;
}
