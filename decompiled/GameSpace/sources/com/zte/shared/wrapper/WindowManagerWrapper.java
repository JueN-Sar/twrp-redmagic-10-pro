...
public class WindowManagerWrapper {
    ...
    public static class LayoutParams {
        ...
        public static void addHidePrivateFlags(WindowManager.LayoutParams layoutParams, int i) {
        ...
        public static void addPrivateFlags(WindowManager.LayoutParams layoutParams, int i) {
            setPrivateFlags(layoutParams, i, i);
        }

        public static void clearPrivateFlags(WindowManager.LayoutParams layoutParams, int i) {
            setPrivateFlags(layoutParams, 0, i);
        }
        ...
        private static void setPrivateFlags(WindowManager.LayoutParams layoutParams, int i, int i2) {
            layoutParams.privateFlags = (i & i2) | (layoutParams.privateFlags & (~i2));
        }
    }
