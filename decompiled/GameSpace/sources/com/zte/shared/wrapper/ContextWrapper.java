...
public class ContextWrapper {
    ...
    public static Context createWindowContext(Context context, int i) {
        return context.createWindowContext(i, null);
    }
    ...
    public static void updateDisplay(Context context, int i) {
