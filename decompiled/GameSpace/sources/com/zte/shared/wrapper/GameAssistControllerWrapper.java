...
public class GameAssistControllerWrapper {
    ...
    private static final class FileCallback {
        ...
        private final ICallback mToken = new ICallback.Stub() { // from class: com.zte.shared.wrapper.GameAssistControllerWrapper.FileCallback.1
            ...
            public void callback(String str, Bundle bundle) {
                if (GAControllerProxy.INVAKE_READ_FILE.equals(str)) {
                    String string = bundle.getString("bundle_key_value", "");
    ...
    public interface FocusWindowCallback {
        void onFocusWindowChanged(String str, int i, Rect rect, Bundle bundle);
    }

    public interface FullActivityFirstCreateCallback {
        void onFullActivityFirstCreate(ComponentName componentName, ActivityInfo activityInfo, int i, int i2, int i3, int i4, int i5, int i6, Bundle bundle);
    }

    public interface FullActivityResumedCallback {
        void onFullActivityResumed(ComponentName componentName, ActivityInfo activityInfo, int i, int i2, int i3, int i4, int i5, int i6, Bundle bundle);
    }
    ...
    public static class SystemCallback extends ICallback.Stub {
        ...
        public void callback(String str, Bundle bundle) {
            ...
            if (c == 3 && this.mSystemWindowCallback != null && bundle.containsKey("show") && bundle.containsKey("title") && bundle.containsKey("package_name") && bundle.containsKey("window_type")) {
        ...
        public void registerAppCallback() {
            try {
                GameAssistControllerWrapper.getGameAssistController().invake(GAControllerProxy.INVAKE_REGISTER_APP_CALLBACK, null, this);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        public void unregisterAppCallback() {
            try {
                GameAssistControllerWrapper.getGameAssistController().invake(GAControllerProxy.INVAKE_UNREGISTER_APP_CALLBACK, null, this);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public interface SystemWindowCallback {
        void onSystemWindowChanged(boolean z, String str, String str2, int i, Bundle bundle);
    }
    ...
    public static void readNode(String str, Consumer<String> consumer) {
        if (consumer != null) {
            try {
                ...
                getGameAssistController().invake(GAControllerProxy.INVAKE_READ_FILE, bundle, new FileCallback(consumer).mToken);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public static void writeNode(String str, String str2) {
        ...
        GameAssistWrapper.getInstance().invake(GAControllerProxy.INVAKE_WRITE_FILE, bundle, (GameAssistWrapper.Callback) null);
    }
}
