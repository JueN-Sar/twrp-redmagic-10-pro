...
final class XingSeeker implements Seeker {
    ...
    public static XingSeeker create(XingFrame xingFrame, long j) {
        ...
        return (xingFrame.dataSize == -1 || xingFrame.tableOfContents == null) ? new XingSeeker(j, xingFrame.header.frameSize, computeDurationUs, xingFrame.header.bitrate) : new XingSeeker(j, xingFrame.header.frameSize, computeDurationUs, xingFrame.header.bitrate, xingFrame.dataSize, xingFrame.tableOfContents);
    }
