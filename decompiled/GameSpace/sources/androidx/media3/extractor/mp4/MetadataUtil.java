...
final class MetadataUtil {
    ...
    private static Id3Frame parseIntegerAttribute(int i, String str, ParsableByteArray parsableByteArray, boolean z, boolean z2) {
        ...
        if (parseIntegerAttribute >= 0) {
            return z ? new TextInformationFrame(str, (String) null, ImmutableList.of(Integer.toString(parseIntegerAttribute))) : new CommentFrame(C.LANGUAGE_UNDETERMINED, str, Integer.toString(parseIntegerAttribute));
        }
