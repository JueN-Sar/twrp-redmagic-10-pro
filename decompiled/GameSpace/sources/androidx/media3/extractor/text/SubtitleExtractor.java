...
public class SubtitleExtractor implements Extractor {
    ...
    private void parseAndWriteToOutput() throws IOException {
        try {
            ...
            this.subtitleParser.parse(this.subtitleData, j != C.TIME_UNSET ? SubtitleParser.OutputOptions.cuesAfterThenRemainingCuesBefore(j) : SubtitleParser.OutputOptions.allCues(), new Consumer() { // from class: androidx.media3.extractor.text.SubtitleExtractor$$ExternalSyntheticLambda0
                @Override // androidx.media3.common.util.Consumer
                public final void accept(Object obj) {
                    SubtitleExtractor.this.m168xdbba10ad((CuesWithTiming) obj);
                }
            });
    ...
    /* synthetic */ void m168xdbba10ad(CuesWithTiming cuesWithTiming) {
