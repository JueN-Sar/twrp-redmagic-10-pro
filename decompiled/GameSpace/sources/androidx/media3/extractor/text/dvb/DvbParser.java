...
public final class DvbParser implements SubtitleParser {
    ...
    private CuesWithTiming parse(ParsableBitArray parsableBitArray) {
        ...
        for (int i2 = 0; i2 < sparseArray2.size(); i2++) {
            this.canvas.save();
            PageRegion valueAt = sparseArray2.valueAt(i2);
            RegionComposition regionComposition = this.subtitleService.regions.get(sparseArray2.keyAt(i2));
            ...
            while (i5 < sparseArray3.size()) {
                ...
                RegionObject valueAt2 = sparseArray3.valueAt(i5);
                ...
                if (objectData2 != null) {
                    ...
                    paintPixelDataSubBlocks(objectData2, clutDefinition, regionComposition.depth, valueAt2.horizontalPosition + i3, i4 + valueAt2.verticalPosition, objectData2.nonModifyingColorFlag ? null : this.defaultPaint, this.canvas);
                } else {
                    i = i5;
                    sparseArray = sparseArray3;
                }
