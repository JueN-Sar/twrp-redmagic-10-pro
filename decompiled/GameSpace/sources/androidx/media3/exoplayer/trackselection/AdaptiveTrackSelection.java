        ...
        public final ExoTrackSelection[] createTrackSelections(ExoTrackSelection.Definition[] definitionArr, BandwidthMeter bandwidthMeter, MediaSource.MediaPeriodId mediaPeriodId, Timeline timeline) {
            ...
            for (int i = 0; i < definitionArr.length; i++) {
                ...
                if (definition != null && definition.tracks.length != 0) {
                    exoTrackSelectionArr[i] = definition.tracks.length == 1 ? new FixedTrackSelection(definition.group, definition.tracks[0], definition.type) : createAdaptiveTrackSelection(definition.group, definition.tracks, definition.type, bandwidthMeter, (ImmutableList) adaptationCheckpoints.get(i));
                }
            }
