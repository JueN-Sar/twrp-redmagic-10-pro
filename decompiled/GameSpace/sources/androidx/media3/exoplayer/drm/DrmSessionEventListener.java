...
public interface DrmSessionEventListener {
    ...
    public static class EventDispatcher {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: androidx.media3.exoplayer.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda4
                    ...
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m95x8fe293c0(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public void drmKeysRemoved() {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: androidx.media3.exoplayer.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m96x5d8fdb2(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public void drmKeysRestored() {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: androidx.media3.exoplayer.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m97xcfc47b53(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public void drmSessionAcquired(final int i) {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: androidx.media3.exoplayer.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m98x3233dce6(drmSessionEventListener, i);
                    }
                });
            }
        }
        ...
        public void drmSessionManagerError(final Exception exc) {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: androidx.media3.exoplayer.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m99x18253075(drmSessionEventListener, exc);
                    }
                });
            }
        }
        ...
        public void drmSessionReleased() {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: androidx.media3.exoplayer.drm.DrmSessionEventListener$EventDispatcher$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.m100x690251a(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m95x8fe293c0(DrmSessionEventListener drmSessionEventListener) {
        ...
        /* synthetic */ void m96x5d8fdb2(DrmSessionEventListener drmSessionEventListener) {
        ...
        /* synthetic */ void m97xcfc47b53(DrmSessionEventListener drmSessionEventListener) {
        ...
        /* synthetic */ void m98x3233dce6(DrmSessionEventListener drmSessionEventListener, int i) {
        ...
        /* synthetic */ void m99x18253075(DrmSessionEventListener drmSessionEventListener, Exception exc) {
        ...
        /* synthetic */ void m100x690251a(DrmSessionEventListener drmSessionEventListener) {
