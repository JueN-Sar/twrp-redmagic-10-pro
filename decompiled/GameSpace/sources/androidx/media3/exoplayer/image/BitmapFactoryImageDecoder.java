...
public final class BitmapFactoryImageDecoder extends SimpleDecoder<DecoderInputBuffer, ImageOutputBuffer, ImageDecoderException> implements ImageDecoder {
    ...
    public static final class Factory implements ImageDecoder.Factory {
        ...
        public int supportsFormat(Format format) {
            return (format.sampleMimeType == null || !MimeTypes.isImage(format.sampleMimeType)) ? RendererCapabilities.create(0) : Util.isBitmapFactorySupportedMimeType(format.sampleMimeType) ? RendererCapabilities.create(4) : RendererCapabilities.create(1);
        }
    }
