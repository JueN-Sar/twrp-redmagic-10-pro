...
public abstract class DecoderAudioRenderer<T extends Decoder<DecoderInputBuffer, ? extends SimpleDecoderOutputBuffer, ? extends DecoderException>> extends BaseRenderer implements MediaClock {
    ...
    private void onInputFormatChanged(FormatHolder formatHolder) throws ExoPlaybackException {
        ...
        DecoderReuseEvaluation decoderReuseEvaluation = this.sourceDrmSession != this.decoderDrmSession ? new DecoderReuseEvaluation(this.decoder.getName(), format2, format, 0, 128) : canReuseDecoder(t.getName(), format2, format);
