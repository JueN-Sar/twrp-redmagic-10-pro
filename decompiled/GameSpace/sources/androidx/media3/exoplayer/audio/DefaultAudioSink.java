...
public final class DefaultAudioSink implements AudioSink {
    ...
    private static final class Configuration {
        ...
        private AudioTrack createAudioTrack(AudioAttributes audioAttributes, int i) {
            return Util.SDK_INT >= 29 ? createAudioTrackV29(audioAttributes, i) : Util.SDK_INT >= 21 ? createAudioTrackV21(audioAttributes, i) : createAudioTrackV9(audioAttributes, i);
        }
    ...
    public long getWrittenFrames() {
        return this.configuration.outputMode == 0 ? Util.ceilDivide(this.writtenPcmBytes, this.configuration.outputPcmFrameSize) : this.writtenEncodedFrames;
    }
    ...
    */
    ...
    public void configure(Format format, int i, int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if (i != 0) {
            ...
            i9 = i2;
            i10 = i3;
            bufferSizeInBytes = this.audioTrackBufferSizeProvider.getBufferSizeInBytes(getAudioTrackMinBufferSize(i3, intValue, i4), i4, i5, i2 != -1 ? i2 : 1, i3, i16, z2 ? 8.0d : 1.0d);
        }
        this.offloadDisabledUntilNextConfiguration = false;
        Configuration configuration = new Configuration(format, i6, i5, i9, i10, i8, i7, bufferSizeInBytes, audioProcessingPipeline, z2, z, this.tunneling);
        if (isAudioTrackInitialized()) {
    ...
    public void onAudioCapabilitiesChanged(AudioCapabilities audioCapabilities) {
        ...
        if (looper != myLooper) {
            throw new IllegalStateException("Current looper (" + (myLooper != null ? myLooper.getThread().getName() : "null") + ") is not the playback looper (" + (looper == null ? "null" : looper.getThread().getName()) + ")");
        }
