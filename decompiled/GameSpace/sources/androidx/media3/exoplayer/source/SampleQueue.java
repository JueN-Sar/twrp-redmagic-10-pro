    ...
    */
    ...
    public final synchronized boolean seekTo(long j, boolean z) {
        ...
        if (hasNextSample() && j >= this.timesUs[relativeIndex] && (j <= this.largestQueuedTimestampUs || z)) {
            int findSampleAfter = this.allSamplesAreSyncSamples ? findSampleAfter(relativeIndex, this.length - this.readPosition, j, z) : findSampleBefore(relativeIndex, this.length - this.readPosition, j, true);
