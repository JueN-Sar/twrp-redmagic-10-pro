...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
    ...
    private static final class SharedMediaPeriod implements MediaPeriod.Callback {
        ...
        private long getStreamPositionUsWithNotYetStartedHandling(MediaPeriodImpl mediaPeriodImpl, long j) {
            return j < mediaPeriodImpl.lastStartPositionUs ? ServerSideAdInsertionUtil.getStreamPositionUs(mediaPeriodImpl.lastStartPositionUs, mediaPeriodImpl.mediaPeriodId, this.adPlaybackState) - (mediaPeriodImpl.lastStartPositionUs - j) : ServerSideAdInsertionUtil.getStreamPositionUs(j, mediaPeriodImpl.mediaPeriodId, this.adPlaybackState);
        }
    ...
    /* synthetic */ void m140x8b1696bf(ImmutableMap immutableMap, Timeline timeline) {
            ...
            if (handler == null) {
                ...
                handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.ServerSideAdInsertionMediaSource$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        ServerSideAdInsertionMediaSource.this.m140x8b1696bf(immutableMap, timeline);
                    }
                });
            }
        }
