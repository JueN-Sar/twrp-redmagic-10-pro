...
public class SonicAudioProcessor implements AudioProcessor {
    ...
    public final long getMediaDuration(long j) {
        ...
        return this.outputAudioFormat.sampleRate == this.inputAudioFormat.sampleRate ? Util.scaleLargeTimestamp(j, pendingInputBytes, this.outputBytes) : Util.scaleLargeTimestamp(j, pendingInputBytes * this.outputAudioFormat.sampleRate, this.outputBytes * this.inputAudioFormat.sampleRate);
    }
    ...
    public final long getPlayoutDuration(long j) {
        ...
        long pendingInputBytes = this.inputBytes - ((Sonic) Assertions.checkNotNull(this.sonic)).getPendingInputBytes();
        return this.outputAudioFormat.sampleRate == this.inputAudioFormat.sampleRate ? Util.scaleLargeTimestamp(j, this.outputBytes, pendingInputBytes) : Util.scaleLargeTimestamp(j, this.outputBytes * this.inputAudioFormat.sampleRate, pendingInputBytes * this.outputAudioFormat.sampleRate);
    }
