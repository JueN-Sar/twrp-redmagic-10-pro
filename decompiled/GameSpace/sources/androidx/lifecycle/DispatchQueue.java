...
public final class DispatchQueue {
    ...
    public static final void m42dispatchAndEnqueue$lambda2$lambda1(DispatchQueue this$0, Runnable runnable) {
    ...
    public final void dispatchAndEnqueue(CoroutineContext context, final Runnable runnable) {
        ...
        if (immediate.isDispatchNeeded(context) || canRun()) {
            immediate.mo2001dispatch(context, new Runnable() { // from class: androidx.lifecycle.DispatchQueue$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    DispatchQueue.m42dispatchAndEnqueue$lambda2$lambda1(DispatchQueue.this, runnable);
                }
            });
        } else {
            enqueue(runnable);
