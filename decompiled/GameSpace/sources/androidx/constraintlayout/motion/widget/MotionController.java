...
public class MotionController {
    ...
    void buildBounds(float[] fArr, int i) {
        ...
        if (hashMap != null) {
            hashMap.get(AnimatorHelper.Item.TRANSLATIONX);
        }
        HashMap<String, SplineSet> hashMap2 = this.mAttributesMap;
        if (hashMap2 != null) {
            hashMap2.get(AnimatorHelper.Item.TRANSLATIONY);
        }
        HashMap<String, KeyCycleOscillator> hashMap3 = this.mCycleMap;
        if (hashMap3 != null) {
            hashMap3.get(AnimatorHelper.Item.TRANSLATIONX);
        }
        HashMap<String, KeyCycleOscillator> hashMap4 = this.mCycleMap;
        if (hashMap4 != null) {
            hashMap4.get(AnimatorHelper.Item.TRANSLATIONY);
        }
    ...
    void buildPath(float[] fArr, int i) {
        ...
        float f2 = 1.0f / (i - 1);
        HashMap<String, SplineSet> hashMap = this.mAttributesMap;
        SplineSet splineSet = hashMap == null ? null : hashMap.get(AnimatorHelper.Item.TRANSLATIONX);
        HashMap<String, SplineSet> hashMap2 = this.mAttributesMap;
        SplineSet splineSet2 = hashMap2 == null ? null : hashMap2.get(AnimatorHelper.Item.TRANSLATIONY);
        HashMap<String, KeyCycleOscillator> hashMap3 = this.mCycleMap;
        KeyCycleOscillator keyCycleOscillator = hashMap3 == null ? null : hashMap3.get(AnimatorHelper.Item.TRANSLATIONX);
        HashMap<String, KeyCycleOscillator> hashMap4 = this.mCycleMap;
        KeyCycleOscillator keyCycleOscillator2 = hashMap4 != null ? hashMap4.get(AnimatorHelper.Item.TRANSLATIONY) : null;
        int i2 = 0;
        while (i2 < i) {
            float f3 = i2 * f2;
    ...
    void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        SplineSet splineSet3 = hashMap3 == null ? null : hashMap3.get(AnimatorHelper.Item.ROTATE);
        HashMap<String, SplineSet> hashMap4 = this.mAttributesMap;
        SplineSet splineSet4 = hashMap4 == null ? null : hashMap4.get(AnimatorHelper.Item.SCALEX);
        HashMap<String, SplineSet> hashMap5 = this.mAttributesMap;
        SplineSet splineSet5 = hashMap5 == null ? null : hashMap5.get(AnimatorHelper.Item.SCALEY);
        HashMap<String, KeyCycleOscillator> hashMap6 = this.mCycleMap;
        KeyCycleOscillator keyCycleOscillator = hashMap6 == null ? null : hashMap6.get(AnimatorHelper.Item.TRANSLATIONX);
        HashMap<String, KeyCycleOscillator> hashMap7 = this.mCycleMap;
        KeyCycleOscillator keyCycleOscillator2 = hashMap7 == null ? null : hashMap7.get(AnimatorHelper.Item.TRANSLATIONY);
        HashMap<String, KeyCycleOscillator> hashMap8 = this.mCycleMap;
        KeyCycleOscillator keyCycleOscillator3 = hashMap8 == null ? null : hashMap8.get(AnimatorHelper.Item.ROTATE);
        HashMap<String, KeyCycleOscillator> hashMap9 = this.mCycleMap;
        KeyCycleOscillator keyCycleOscillator4 = hashMap9 == null ? null : hashMap9.get(AnimatorHelper.Item.SCALEX);
        HashMap<String, KeyCycleOscillator> hashMap10 = this.mCycleMap;
        KeyCycleOscillator keyCycleOscillator5 = hashMap10 != null ? hashMap10.get(AnimatorHelper.Item.SCALEY) : null;
