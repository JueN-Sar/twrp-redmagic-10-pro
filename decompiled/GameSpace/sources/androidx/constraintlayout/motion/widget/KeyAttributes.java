...
public class KeyAttributes extends Key {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:132:0x009f, code lost:
        ...
        if (r1.equals(cn.nubia.gamecenter.settings.helper.AnimatorHelper.Item.SCALEY) == false) goto L12;
     */
    ...
    */
    ...
    public void getAttributeNames(HashSet<String> hashSet) {
        if (!Float.isNaN(this.mAlpha)) {
            hashSet.add(AnimatorHelper.Item.ALPHA);
        }
        if (!Float.isNaN(this.mElevation)) {
            hashSet.add("elevation");
        }
        if (!Float.isNaN(this.mRotation)) {
            hashSet.add(AnimatorHelper.Item.ROTATE);
        }
        ...
        if (!Float.isNaN(this.mTranslationX)) {
            hashSet.add(AnimatorHelper.Item.TRANSLATIONX);
        }
        if (!Float.isNaN(this.mTranslationY)) {
            hashSet.add(AnimatorHelper.Item.TRANSLATIONY);
        }
        ...
        if (!Float.isNaN(this.mScaleX)) {
            hashSet.add(AnimatorHelper.Item.SCALEX);
        }
        if (!Float.isNaN(this.mScaleX)) {
            hashSet.add(AnimatorHelper.Item.SCALEY);
        }
    ...
    public void setInterpolation(HashMap<String, Integer> hashMap) {
        ...
        if (!Float.isNaN(this.mAlpha)) {
            hashMap.put(AnimatorHelper.Item.ALPHA, Integer.valueOf(this.mCurveFit));
        }
        if (!Float.isNaN(this.mElevation)) {
            hashMap.put("elevation", Integer.valueOf(this.mCurveFit));
        }
        if (!Float.isNaN(this.mRotation)) {
            hashMap.put(AnimatorHelper.Item.ROTATE, Integer.valueOf(this.mCurveFit));
        }
        if (!Float.isNaN(this.mRotationX)) {
        ...
        if (!Float.isNaN(this.mTranslationX)) {
            hashMap.put(AnimatorHelper.Item.TRANSLATIONX, Integer.valueOf(this.mCurveFit));
        }
        if (!Float.isNaN(this.mTranslationY)) {
            hashMap.put(AnimatorHelper.Item.TRANSLATIONY, Integer.valueOf(this.mCurveFit));
        }
        if (!Float.isNaN(this.mTranslationZ)) {
        ...
        if (!Float.isNaN(this.mScaleX)) {
            hashMap.put(AnimatorHelper.Item.SCALEX, Integer.valueOf(this.mCurveFit));
        }
        if (!Float.isNaN(this.mScaleY)) {
            hashMap.put(AnimatorHelper.Item.SCALEY, Integer.valueOf(this.mCurveFit));
        }
        if (!Float.isNaN(this.mProgress)) {
