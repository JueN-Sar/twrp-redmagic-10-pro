...
public class DependencyGraph {
    ...
    private String generateChainDisplayGraph(ChainRun chainRun, String str) {
        ...
        while (it.hasNext()) {
            ...
            str4 = generateDisplayGraph(next, str4);
        }
    ...
    private String nodeDefinition(WidgetRun widgetRun) {
        ...
        String str3 = (((!z ? debugName + "_HORIZONTAL" : debugName + "_VERTICAL") + " [shape=none, label=<") + "<TABLE BORDER=\"0\" CELLSPACING=\"0\" CELLPADDING=\"2\">") + "  <TR>";
        if (z) {
            String str4 = str3 + "    <TD ";
            if (widgetRun.start.resolved) {
                str4 = str4 + " BGCOLOR=\"green\"";
            }
            str = str4 + " PORT=\"TOP\" BORDER=\"1\">T</TD>";
        } else {
            String str5 = str3 + "    <TD ";
            if (widgetRun.start.resolved) {
                str5 = str5 + " BGCOLOR=\"green\"";
            }
            str = str5 + " PORT=\"LEFT\" BORDER=\"1\">L</TD>";
        }
        String str6 = str + "    <TD BORDER=\"1\" ";
        if (widgetRun.dimension.resolved && !widgetRun.widget.measured) {
            ...
            str6 = str6 + " BGCOLOR=\"lightgray\" ";
        } else if (!widgetRun.dimension.resolved && widgetRun.widget.measured) {
            str6 = str6 + " BGCOLOR=\"yellow\" ";
        }
        if (horizontalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            str6 = str6 + "style=\"dashed\"";
        }
        String str7 = str6 + ">" + debugName + (runGroup != null ? " [" + (runGroup.groupIndex + 1) + "/" + RunGroup.index + "]" : "") + " </TD>";
        if (z) {
            String str8 = str7 + "    <TD ";
            if (z && ((VerticalWidgetRun) widgetRun).baseline.resolved) {
                str8 = str8 + " BGCOLOR=\"green\"";
            }
            String str9 = (str8 + " PORT=\"BASELINE\" BORDER=\"1\">b</TD>") + "    <TD ";
            if (widgetRun.end.resolved) {
                str9 = str9 + " BGCOLOR=\"green\"";
            }
            str2 = str9 + " PORT=\"BOTTOM\" BORDER=\"1\">B</TD>";
        } else {
            String str10 = str7 + "    <TD ";
            if (widgetRun.end.resolved) {
                str10 = str10 + " BGCOLOR=\"green\"";
            }
            str2 = str10 + " PORT=\"RIGHT\" BORDER=\"1\">R</TD>";
        }
