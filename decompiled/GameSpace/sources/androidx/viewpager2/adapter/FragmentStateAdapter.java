    ...
    void placeFragmentInViewHolder(final FragmentViewHolder fragmentViewHolder) {
        ...
        if (fragment.isAdded() && view.getParent() != null) {
            ...
            if (shouldDelayFragmentTransactions()) {
                ...
                scheduleViewAttach(fragment, container);
                this.mFragmentManager.beginTransaction().add(fragment, GameSpaceConfig.SUPPORT_INDICATOR + fragmentViewHolder.getItemId()).setMaxLifecycle(fragment, Lifecycle.State.STARTED).commitNow();
