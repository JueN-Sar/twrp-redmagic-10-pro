...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    float mValue;
    float mVelocity;
    public static final ViewProperty TRANSLATION_X = new ViewProperty(AnimatorHelper.Item.TRANSLATIONX) { // from class: androidx.dynamicanimation.animation.DynamicAnimation.1
    ...
    public static final ViewProperty TRANSLATION_Y = new ViewProperty(AnimatorHelper.Item.TRANSLATIONY) { // from class: androidx.dynamicanimation.animation.DynamicAnimation.2
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
    ...
    public static final ViewProperty SCALE_X = new ViewProperty(AnimatorHelper.Item.SCALEX) { // from class: androidx.dynamicanimation.animation.DynamicAnimation.4
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
    ...
    public static final ViewProperty SCALE_Y = new ViewProperty(AnimatorHelper.Item.SCALEY) { // from class: androidx.dynamicanimation.animation.DynamicAnimation.5
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
    ...
    public static final ViewProperty ROTATION = new ViewProperty(AnimatorHelper.Item.ROTATE) { // from class: androidx.dynamicanimation.animation.DynamicAnimation.6
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
    ...
    public static final ViewProperty ALPHA = new ViewProperty(AnimatorHelper.Item.ALPHA) { // from class: androidx.dynamicanimation.animation.DynamicAnimation.12
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
