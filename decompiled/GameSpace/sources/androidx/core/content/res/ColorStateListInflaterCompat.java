    ...
    private static ColorStateList inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                ...
                float f2 = obtainAttributes.hasValue(R.styleable.ColorStateListItem_android_lStar) ? obtainAttributes.getFloat(R.styleable.ColorStateListItem_android_lStar, -1.0f) : obtainAttributes.getFloat(R.styleable.ColorStateListItem_lStar, -1.0f);
                ...
                iArr2 = GrowingArrayUtils.append(iArr2, i2, modulateColorAlpha(color, f, f2));
