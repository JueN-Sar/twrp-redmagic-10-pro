...
public final class EmbeddingAdapter {
    ...
    public static final boolean m196translateActivityIntentPredicates$lambda3(EmbeddingAdapter this$0, Set splitPairFilters, Pair pair) {
    ...
    public static final boolean m197translateActivityPairPredicates$lambda1(EmbeddingAdapter this$0, Set splitPairFilters, Pair pair) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(splitPairFilters, "$splitPairFilters");
        Intrinsics.checkNotNullExpressionValue(pair, "(first, second)");
        Activity activity = (Activity) this$0.component1(pair);
    ...
    public static final boolean m198translateActivityPredicates$lambda6(Set activityFilters, Activity activity) {
    ...
    public static final boolean m199translateIntentPredicates$lambda8(Set activityFilters, Intent intent) {
        Intrinsics.checkNotNullParameter(activityFilters, "$activityFilters");
        Set<ActivityFilter> set = activityFilters;
        if ((set instanceof Collection) && set.isEmpty()) {
            return false;
    ...
    public static final boolean m200translateParentMetricsPredicate$lambda4(SplitRule splitRule, WindowMetrics windowMetrics) {
    ...
    public final Predicate<Pair<Activity, Intent>> translateActivityIntentPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda3
            ...
            public final boolean test(Object obj) {
                boolean m196translateActivityIntentPredicates$lambda3;
                m196translateActivityIntentPredicates$lambda3 = EmbeddingAdapter.m196translateActivityIntentPredicates$lambda3(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m196translateActivityIntentPredicates$lambda3;
            }
        };
    }
    ...
    public final Predicate<Pair<Activity, Activity>> translateActivityPairPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m197translateActivityPairPredicates$lambda1;
                m197translateActivityPairPredicates$lambda1 = EmbeddingAdapter.m197translateActivityPairPredicates$lambda1(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m197translateActivityPairPredicates$lambda1;
            }
        };
    }
    ...
    public final Predicate<Activity> translateActivityPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda4
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m198translateActivityPredicates$lambda6;
                m198translateActivityPredicates$lambda6 = EmbeddingAdapter.m198translateActivityPredicates$lambda6(activityFilters, (Activity) obj);
                return m198translateActivityPredicates$lambda6;
            }
        };
    }
    ...
    public final Predicate<Intent> translateIntentPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m199translateIntentPredicates$lambda8;
                m199translateIntentPredicates$lambda8 = EmbeddingAdapter.m199translateIntentPredicates$lambda8(activityFilters, (Intent) obj);
                return m199translateIntentPredicates$lambda8;
            }
        };
    }
    ...
    public final Predicate<WindowMetrics> translateParentMetricsPredicate(final SplitRule splitRule) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m200translateParentMetricsPredicate$lambda4;
                m200translateParentMetricsPredicate$lambda4 = EmbeddingAdapter.m200translateParentMetricsPredicate$lambda4(SplitRule.this, (WindowMetrics) obj);
                return m200translateParentMetricsPredicate$lambda4;
            }
        };
    }
}
