        ...
        */
        public final java.lang.Object prepare(kotlinx.coroutines.internal.AtomicOp<?> r7) {
            ...
            L3a:
                ...
                goto L0
            L53:
                boolean r6 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch: java.lang.Throwable -> L63
                if (r6 == 0) goto L62
                if (r4 != 0) goto L5c
                goto L62
            L5c:
    ...
    public static final class PrepareOp extends OpDescriptor {
        ...
        public Object perform(Object affected) {
            ...
            if (onPrepare != LockFreeLinkedList_commonKt.REMOVE_PREPARED) {
                ...
                LockFreeLinkedListNode._next$FU.compareAndSet(lockFreeLinkedListNode, this, decide == AtomicKt.NO_DECISION ? getAtomicOp() : decide == null ? this.desc.updatedNext(lockFreeLinkedListNode, this.next) : this.next);
                return null;
            }
    ...
    */
    ...
    public final LockFreeLinkedListNode removeFirstOrNull() {
        while (true) {
            ...
            if (lockFreeLinkedListNode.mo2000remove()) {
                return lockFreeLinkedListNode;
            }
