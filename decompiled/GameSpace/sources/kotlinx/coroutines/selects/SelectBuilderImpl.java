...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    public final void handleBuilderException(Throwable e) {
        if (trySelect()) {
            ...
            resumeWith(Result.m467constructorimpl(ResultKt.createFailure(e)));
        } else {
        ...
        while (true) {
            ...
            if (obj4 == obj) {
                ...
                if (atomicReferenceFieldUpdater2.compareAndSet(this, coroutine_suspended, obj3)) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    intercepted.resumeWith(Result.m467constructorimpl(ResultKt.createFailure(exception)));
                    return;
                }
            }
        }
    ...
    public void resumeWith(Object result) {
        ...
        while (true) {
            ...
            if (obj4 == obj) {
                ...
                obj3 = SelectKt.RESUMED;
                if (atomicReferenceFieldUpdater2.compareAndSet(this, coroutine_suspended, obj3)) {
                    if (!Result.m473isFailureimpl(result)) {
                        this.uCont.resumeWith(result);
                        return;
                    }
                    Continuation<R> continuation = this.uCont;
                    Throwable m470exceptionOrNullimpl = Result.m470exceptionOrNullimpl(result);
                    Intrinsics.checkNotNull(m470exceptionOrNullimpl);
                    Result.Companion companion = Result.INSTANCE;
                    if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                        m470exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m470exceptionOrNullimpl, (CoroutineStackFrame) continuation);
                    }
                    continuation.resumeWith(Result.m467constructorimpl(ResultKt.createFailure(m470exceptionOrNullimpl)));
                    return;
                }
            }
        }
