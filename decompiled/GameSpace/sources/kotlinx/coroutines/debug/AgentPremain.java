...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m467constructorimpl = Result.m467constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m467constructorimpl = Result.m467constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m473isFailureimpl(m467constructorimpl) ? null : m467constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1978installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1978installSignalHandler$lambda1(Signal signal) {
