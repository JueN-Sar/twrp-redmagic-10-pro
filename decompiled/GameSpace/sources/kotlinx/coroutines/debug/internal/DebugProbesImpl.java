...
public final class DebugProbesImpl {
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String state, Thread thread, List<StackTraceElement> coroutineTrace) {
        ...
        try {
            ...
            m467constructorimpl = Result.m467constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
        ...
        StackTraceElement[] stackTraceElementArr = (StackTraceElement[]) m467constructorimpl;
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        m467constructorimpl = Result.m467constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
        if (Result.m473isFailureimpl(m467constructorimpl)) {
            m467constructorimpl = null;
        }
        return (Function1) m467constructorimpl;
    }
