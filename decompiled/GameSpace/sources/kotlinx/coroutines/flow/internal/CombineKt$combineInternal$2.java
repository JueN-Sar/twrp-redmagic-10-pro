...
final class CombineKt$combineInternal$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        static final class C00361<T> implements FlowCollector, SuspendFunction {
            final /* synthetic */ int $i;
            final /* synthetic */ Channel<IndexedValue<Object>> $resultChannel;
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (i == 0) {
                    ...
                    this.label = 1;
                    if (this.$flows[this.$i].collect(new C00361(this.$resultChannel, this.$i), this) == coroutine_suspended) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:19:0x00d1 A[LOOP:0: B:19:0x00d1->B:37:?, LOOP_START, PHI: r6 r10
      0x00d1: PHI (r6v9 int) = (r6v8 int), (r6v10 int) binds: [B:16:0x00cc, B:37:?] A[DONT_GENERATE, DONT_INLINE]
      0x00d1: PHI (r10v5 kotlin.collections.IndexedValue) = (r10v4 kotlin.collections.IndexedValue), (r10v18 kotlin.collections.IndexedValue) binds: [B:16:0x00cc, B:37:?] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:35:0x013d -> B:10:0x013f). Please report as a decompilation issue!!! */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
