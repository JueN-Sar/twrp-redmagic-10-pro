...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    private final String getQueueDebugStateString() {
        ...
        String lockFreeLinkedListNode = nextNode instanceof Closed ? nextNode.toString() : nextNode instanceof Receive ? "ReceiveQueued" : nextNode instanceof Send ? "SendQueued" : Intrinsics.stringPlus("UNEXPECTED:", nextNode);
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (receive.mo2000remove()) {
                m1992constructorimpl$default = InlineList.m1997plusFjFbRPM(m1992constructorimpl$default, receive);
            } else {
                receive.helpRemove();
            }
        }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 == null || (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) == null) {
            ...
            continuation.resumeWith(Result.m467constructorimpl(ResultKt.createFailure(sendException)));
        } else {
            ...
            continuation.resumeWith(Result.m467constructorimpl(ResultKt.createFailure(undeliveredElementException)));
        }
    }
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m467constructorimpl(Unit.INSTANCE));
                break;
            }
    ...
    */
    ...
    public final Object mo1955trySendJP2dKIU(E element) {
        Object offerInternal = offerInternal(element);
        if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.INSTANCE.m1975successJP2dKIU(Unit.INSTANCE);
        }
        if (offerInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.INSTANCE.m1974failurePtdJZtk() : ChannelResult.INSTANCE.m1973closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (offerInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m1973closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        }
