...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1955trySendJP2dKIU = sendChannel.mo1955trySendJP2dKIU(e);
            if (ChannelResult.m1970isSuccessimpl(mo1955trySendJP2dKIU)) {
                return true;
            }
            Throwable m1964exceptionOrNullimpl = ChannelResult.m1964exceptionOrNullimpl(mo1955trySendJP2dKIU);
    ...
    Object mo1955trySendJP2dKIU(E element);
}
