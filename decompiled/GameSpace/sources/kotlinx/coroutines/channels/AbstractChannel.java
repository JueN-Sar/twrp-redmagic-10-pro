...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m467constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.INSTANCE;
                        cancellableContinuationImpl.resumeWith(Result.m467constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m467constructorimpl(ChannelResult.m1960boximpl(ChannelResult.INSTANCE.m1973closedJP2dKIU(closed.closeCause))));
            } else {
                CancellableContinuation<Object> cancellableContinuation2 = this.cont;
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m467constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
            }
        }

        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m1960boximpl(ChannelResult.INSTANCE.m1975successJP2dKIU(value)) : value;
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E value) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1960boximpl(ChannelResult.INSTANCE.m1975successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1960boximpl(ChannelResult.INSTANCE.m1973closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            if (i == 1) {
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1960boximpl(z ? ChannelResult.INSTANCE.m1973closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.INSTANCE.m1975successJP2dKIU(obj)), selectInstance.getCompletion());
                return;
            } else {
        ...
        if (i == 1 && selectInstance.trySelect()) {
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1960boximpl(ChannelResult.INSTANCE.m1973closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
        }
    }
    ...
    protected boolean enqueueReceiveInternal(Receive<? super E> receive) {
        ...
        if (!isBufferAlwaysEmpty()) {
            ...
            do {
                ...
                tryCondAddNext = prevNode2.tryCondAddNext(receive2, queue, condAddOp);
                if (tryCondAddNext != 1) {
                }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        while (true) {
            ...
            if (prevNode instanceof LockFreeLinkedListHead) {
                mo1952onCancelIdempotentListww6eGU(m1992constructorimpl$default, closedForSend);
                return;
            } else {
                if (DebugKt.getASSERTIONS_ENABLED() && !(prevNode instanceof Send)) {
                    throw new AssertionError();
                }
                if (prevNode.mo2000remove()) {
                    m1992constructorimpl$default = InlineList.m1997plusFjFbRPM(m1992constructorimpl$default, (Send) prevNode);
                } else {
                    prevNode.helpRemove();
                }
            }
    ...
    protected void mo1952onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
    ...
    */
    public final java.lang.Object mo1953receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L32:
            ...
            if (r4 == 0) goto L4c
            kotlinx.coroutines.channels.ChannelResult$Companion r4 = kotlinx.coroutines.channels.ChannelResult.INSTANCE
            kotlinx.coroutines.channels.Closed r5 = (kotlinx.coroutines.channels.Closed) r5
            java.lang.Throwable r5 = r5.closeCause
            java.lang.Object r4 = r4.m1973closedJP2dKIU(r5)
            goto L52
        L4c:
            kotlinx.coroutines.channels.ChannelResult$Companion r4 = kotlinx.coroutines.channels.ChannelResult.INSTANCE
            java.lang.Object r4 = r4.m1975successJP2dKIU(r5)
        L52:
            return r4
        L53:
            r0.label = r3
        ...
        L5c:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo1953receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public final Object mo1954tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1974failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.INSTANCE.m1973closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.INSTANCE.m1975successJP2dKIU(pollInternal);
    }
}
