        ...
        */
        protected java.lang.Object pollInternal() {
            /*
                ...
                r0.lock()
                java.lang.Object r1 = r6.peekUnderLock()     // Catch: java.lang.Throwable -> L46
            ...
            L14:
                ...
                goto L21
            L16:
                long r2 = r6.get_subHead()     // Catch: java.lang.Throwable -> L46
                r4 = 1
                long r2 = r2 + r4
                r6.setSubHead(r2)     // Catch: java.lang.Throwable -> L46
                r2 = 1
            L21:
                r0.unlock()
            ...
            L3d:
                if (r2 == 0) goto L45
            L3f:
                kotlinx.coroutines.channels.ArrayBroadcastChannel<E> r6 = r6.broadcastChannel
                r0 = 3
                kotlinx.coroutines.channels.ArrayBroadcastChannel.updateHead$default(r6, r3, r3, r0, r3)
            L45:
                return r1
            L46:
                r6 = move-exception
