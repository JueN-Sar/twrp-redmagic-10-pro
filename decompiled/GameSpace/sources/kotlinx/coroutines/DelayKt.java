...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2002scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1939delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1940toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1940toDelayMillisLRDsOJo(long j) {
        if (Duration.m1780compareToLRDsOJo(j, Duration.INSTANCE.m1883getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1799getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
