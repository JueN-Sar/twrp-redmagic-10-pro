...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> continuation) {
        ...
        try {
            ...
            m467constructorimpl = Result.m467constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
        ...
        if (Result.m470exceptionOrNullimpl(m467constructorimpl) != null) {
            m467constructorimpl = ((Object) continuation.getClass().getName()) + '@' + getHexAddress(continuation);
        }
        return (String) m467constructorimpl;
    }
}
