...
public final class DurationKt {
    ...
    public static final long durationOf(long j, int i) {
        return Duration.m1781constructorimpl((j << 1) + i);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m1781constructorimpl((j << 1) + 1);
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1781constructorimpl(j << 1);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long m1883getZEROUwyO8pc = Duration.INSTANCE.m1883getZEROUwyO8pc();
        ...
        if (str2.charAt(i3) == 'P') {
            ...
            while (i4 < length) {
                if (str2.charAt(i4) != 'T') {
                    ...
                    if (durationUnitByIsoChar != DurationUnit.SECONDS || indexOf$default <= 0) {
                        z4 = z7;
                        m1883getZEROUwyO8pc = Duration.m1817plusLRDsOJo(m1883getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    } else {
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring2 = substring.substring(0, indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring2, "this as java.lang.String…ing(startIndex, endIndex)");
                        z4 = z7;
                        long m1817plusLRDsOJo = Duration.m1817plusLRDsOJo(m1883getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "this as java.lang.String).substring(startIndex)");
                        m1883getZEROUwyO8pc = Duration.m1817plusLRDsOJo(m1817plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    }
                    z7 = z4;
            ...
            if (StringsKt.regionMatches(str, i3, "Infinity", 0, Math.max(length - i3, 8), true)) {
                m1883getZEROUwyO8pc = Duration.INSTANCE.m1881getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (i3 < i) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m1817plusLRDsOJo2 = Duration.m1817plusLRDsOJo(m1883getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "this as java.lang.String).substring(startIndex)");
                        m1883getZEROUwyO8pc = Duration.m1817plusLRDsOJo(m1817plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i3 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m1883getZEROUwyO8pc = Duration.m1817plusLRDsOJo(m1883getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
                    str2 = str;
                    str5 = str7;
        ...
        return z2 ? Duration.m1833unaryMinusUwyO8pc(m1883getZEROUwyO8pc) : m1883getZEROUwyO8pc;
    }
    ...
    private static final long m1906timeskIfJnKk(double d, long j) {
        return Duration.m1818timesUwyO8pc(j, d);
    }

    /* renamed from: times-mvk6XK0, reason: not valid java name */
    private static final long m1907timesmvk6XK0(int i, long j) {
        return Duration.m1819timesUwyO8pc(j, i);
    }
