...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1698fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = UProgressionUtilKt.m1682getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }
    ...
    public String toString() {
        ...
        int i;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) UInt.m606toStringimpl(this.first)).append("..").append((Object) UInt.m606toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            append = new StringBuilder().append((Object) UInt.m606toStringimpl(this.first)).append(" downTo ").append((Object) UInt.m606toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
