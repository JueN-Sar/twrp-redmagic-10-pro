...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1705fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1681getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m639constructorimpl = ((int) ULong.m639constructorimpl(j ^ ULong.m639constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m639constructorimpl2 = (m639constructorimpl + ((int) ULong.m639constructorimpl(j2 ^ ULong.m639constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) ((j3 >>> 32) ^ j3)) + m639constructorimpl2;
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m684toStringimpl(this.first)).append("..").append((Object) ULong.m684toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m684toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m684toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
