...
public class GuidePageAdapter extends RecyclerView.Adapter {
    ...
    class GuidePageHolder extends RecyclerView.ViewHolder {
        ...
        public GuidePageHolder(View view, Callback callback) {
            super(view);
            this.LIGHT = R.mipmap.guide_page_indicator_light;
            this.GRAY = R.mipmap.guide_page_indicator_gray;
        ...
        private void setConfirm(boolean z) {
            if (!z) {
                ...
                this.m_confirmButton.setOnClickListener(new View.OnClickListener() { // from class: cn.nubia.gamelauncher.gamecontrolpanel.GuidePageAdapter.GuidePageHolder.1
        ...
        private void setIndicatorBg(ImageView imageView, int i, int i2) {
            imageView.setBackgroundResource(i == i2 ? R.mipmap.guide_page_indicator_light : R.mipmap.guide_page_indicator_gray);
        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new GuidePageHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.guide_page_item_layout, viewGroup, false), this.m_callback);
    }
}
