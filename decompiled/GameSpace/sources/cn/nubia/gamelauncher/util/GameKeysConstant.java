...
public class GameKeysConstant {
    ...
    public static final String BGM_STATUS = "bgm_status";
    ...
    public static final String HAS_CLICK_ADD_SHORTCUT = "has_click_add_shortcut_icon";
    public static final String HAS_GAME_LAUNCHER_SHORTCUT = "has_game_launcher_shortcut_icon";
    public static final String HOST_MODE_STATE = "gamebox_mirror_displayid";
