...
public class ViewPager extends ViewGroup {
    ...
    private boolean m_bCustomoVertical;
    static final int[] LAYOUT_ATTRS = {R.attr.layout_gravity};
    private static final Comparator<ItemInfo> COMPARATOR = new Comparator<ItemInfo>() { // from class: cn.nubia.gamecenter.settings.widget.ViewPager.1
        @Override // java.util.Comparator
        public int compare(ItemInfo itemInfo, ItemInfo itemInfo2) {
            return itemInfo.position - itemInfo2.position;
        }
    };
    private static final Interpolator sInterpolator = new Interpolator() { // from class: cn.nubia.gamecenter.settings.widget.ViewPager.2
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: cn.nubia.gamecenter.settings.widget.ViewPager.SavedState.1
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new Runnable() { // from class: cn.nubia.gamecenter.settings.widget.ViewPager.3
    ...
    private float adjustOffset(int i, float f) {
        return !getCustomVertical() ? f : i > 0 ? f / 2.0f : f * 2.0f;
    }
    ...
    private int determineTargetPage(int i, float f, int i2, int i3) {
        int i4;
        float f2 = getResources().getFloat(cn.nubia.gamecenter.settings.R.dimen.min_page_offset);
        ...
        return Math.max(this.mItems.get(0).position, Math.min(i4, this.mItems.get(r3.size() - 1).position));
    }
    ...
    */
    public boolean arrowScroll(int r6) {
        ...
        L49:
            ...
            cn.nubia.gamecenter.settings.utils.LogUtil.e(r2, r0)
            goto L7
        L62:
        ...
        Ld2:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.nubia.gamecenter.settings.widget.ViewPager.arrowScroll(int):boolean");
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mLeftEdge.isFinished()) {
            ...
            int width = getWidth();
            if (getCustomVertical()) {
                canvas.translate(this.mFirstOffset * width, getPaddingTop());
        ...
        if (!this.mRightEdge.isFinished()) {
            ...
            if (getCustomVertical()) {
                ...
                canvas.translate(((-(this.mLastOffset + 1.0f)) * width2) + (getPaddingEnd() * 2), getPaddingTop() - height2);
                this.mRightEdge.setSize(width2, height2);
            } else {
                canvas.rotate(90.0f);
    ...
    public boolean getCustomVertical() {
        return this.m_bCustomoVertical;
    }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() { // from class: cn.nubia.gamecenter.settings.widget.ViewPager.4
    ...
    */
    protected void onLayout(boolean r19, int r20, int r21, int r22, int r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.nubia.gamecenter.settings.widget.ViewPager.onLayout(boolean, int, int, int, int):void");
    }
    ...
    */
    protected void onPageScrolled(int r13, float r14, int r15) {
        ...
        L1b:
            ...
            cn.nubia.gamecenter.settings.widget.ViewPager$LayoutParams r9 = (cn.nubia.gamecenter.settings.widget.ViewPager.LayoutParams) r9
        ...
        L6b:
            ...
            cn.nubia.gamecenter.settings.widget.ViewPager$PageTransformer r13 = r12.mPageTransformer
            if (r13 == 0) goto L9f
        ...
        L7a:
            ...
            cn.nubia.gamecenter.settings.widget.ViewPager$LayoutParams r0 = (cn.nubia.gamecenter.settings.widget.ViewPager.LayoutParams) r0
        ...
        L8b:
            ...
            float r3 = (float) r3
            float r0 = r0 / r3
            cn.nubia.gamecenter.settings.widget.ViewPager$PageTransformer r3 = r12.mPageTransformer
        ...
        L9f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.nubia.gamecenter.settings.widget.ViewPager.onPageScrolled(int, float, int):void");
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.nubia.gamecenter.settings.widget.ViewPager.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    */
    void populate(int r18) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.nubia.gamecenter.settings.widget.ViewPager.populate(int):void");
    }
    ...
    public void setCustomVertical(boolean z) {
        this.m_bCustomoVertical = z;
    }
    ...
    public void setOffscreenPageLimit(int i) {
        if (i < 1) {
            LogUtil.w(TAG, "Requested offscreen page limit " + i + " too small; defaulting to 1");
            i = 1;
        }
