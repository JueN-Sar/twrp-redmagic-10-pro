...
public class CacheDispatcher extends Thread {
    ...
    private static class WaitingRequestManager implements Request.NetworkRequestCompleteListener {
        ...
        @Override // cn.nubia.volley.Request.NetworkRequestCompleteListener
    ...
    void processRequest(final Request<?> request) throws InterruptedException {
        ...
        if (this.mWaitingRequestManager.maybeAddToWaitingRequests(request)) {
            ...
            this.mDelivery.postResponse(request, parseNetworkResponse, new Runnable() { // from class: cn.nubia.volley.CacheDispatcher.1
