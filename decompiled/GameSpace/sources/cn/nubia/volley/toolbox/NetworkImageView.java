...
import cn.nubia.volley.toolbox.ImageLoader;
...
public class NetworkImageView extends ImageView {
    ...
    /* renamed from: cn.nubia.volley.toolbox.NetworkImageView$1, reason: invalid class name */
    class AnonymousClass1 implements ImageLoader.ImageListener {
        ...
        public void onResponse(final ImageLoader.ImageContainer imageContainer, boolean z) {
            if (z && this.val$isInLayoutPass) {
                NetworkImageView.this.post(new Runnable() { // from class: cn.nubia.volley.toolbox.NetworkImageView.1.1
