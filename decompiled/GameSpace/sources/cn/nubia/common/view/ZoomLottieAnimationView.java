...
public class ZoomLottieAnimationView extends LottieAnimationView {
    ...
    public ZoomLottieAnimationView(Context context) {
        this(context, null);
    }

    public ZoomLottieAnimationView(Context context, AttributeSet attributeSet) {
    ...
    private void doPressAnimator(final float f, int i) {
        ...
        this.mPressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: cn.nubia.common.view.ZoomLottieAnimationView.1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ZoomLottieAnimationView.this.setScaleAni(((Float) valueAnimator2.getAnimatedValue()).floatValue());
            }
        });
        this.mPressAnimator.addListener(new AnimatorListenerAdapter() { // from class: cn.nubia.common.view.ZoomLottieAnimationView.2
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationCancel(Animator animator) {
                super.onAnimationCancel(animator);
                ZoomLottieAnimationView.this.setScaleAni(1.1f);
            }

            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                super.onAnimationEnd(animator);
                ZoomLottieAnimationView.this.setScaleAni(f);
            }
        });
    }
