package cn.nubia.common.widget;
...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        float height = this.mMaxHeightRatio * ((WindowManager) getContext().getSystemService("window")).getDefaultDisplay().getHeight();
        ...
        setMeasuredDimension(View.resolveSizeAndState(paddingLeft, i, i3), View.resolveSizeAndState(paddingTop, i2, 0));
        if (mode2 == 1073741824) {
            return true;
        }
    ...
    */
    protected void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        Lbf:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.nubia.common.widget.AlertDialogLayout.onLayout(boolean, int, int, int, int):void");
    }
