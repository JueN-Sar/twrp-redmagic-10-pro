...
public class AlertDialogCenter extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            this(context, AlertDialogCenter.resolveDialogTheme(context, 0));
        }

        public Builder(Context context, int i) {
            this.P = new AlertController.AlertParams(new ContextThemeWrapper(context, AlertDialogCenter.resolveDialogTheme(context, i)));
            this.mTheme = i;
        }

        public AlertDialogCenter create() {
            AlertDialogCenter alertDialogCenter = new AlertDialogCenter(this.P.mContext, this.mTheme);
            this.P.apply(alertDialogCenter.mAlert);
            alertDialogCenter.setCancelable(this.P.mCancelable);
            if (this.P.mCancelable) {
                alertDialogCenter.setCanceledOnTouchOutside(true);
            }
            alertDialogCenter.setOnCancelListener(this.P.mOnCancelListener);
            alertDialogCenter.setOnDismissListener(this.P.mOnDismissListener);
            if (this.P.mOnKeyListener != null) {
                alertDialogCenter.setOnKeyListener(this.P.mOnKeyListener);
            }
        ...
        public AlertDialogCenter show() {
            AlertDialogCenter create = create();
            create.show();
            return create;
        }
    }

    protected AlertDialogCenter(Context context) {
        this(context, 0);
    }

    protected AlertDialogCenter(Context context, int i) {
        super(context, resolveDialogTheme(context, i));
        this.mAlert = new AlertController(getContext(), this, null, getWindow(), true);
    }

    protected AlertDialogCenter(Context context, boolean z, DialogInterface.OnCancelListener onCancelListener) {
        this(context, 0);
        setCancelable(z);
    ...
    public void setButtonBackground(int i, int i2, int i3) {
        if (i == 0) {
            i = R.drawable.nubia_center_alert_dialog_left_btn_default_material;
        }
        if (i2 == 0) {
            i2 = R.drawable.nubia_center_alert_dialog_mid_btn_default_material;
        }
        if (i3 == 0) {
            i3 = R.drawable.nubia_center_alert_dialog_right_btn_default_material;
        }
