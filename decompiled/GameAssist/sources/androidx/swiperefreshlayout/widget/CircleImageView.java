...
class CircleImageView extends ImageView {
    ...
    private class OvalShadow extends OvalShape {
        ...
        private RadialGradient f5364c;

        /* renamed from: h, reason: collision with root package name */
        private Paint f5365h = new Paint();
        ...
        private void a(int i2) {
            ...
            this.f5364c = radialGradient;
            this.f5365h.setShader(radialGradient);
        }
        ...
        public void draw(Canvas canvas, Paint paint) {
            ...
            canvas.drawCircle(width, height, width, this.f5365h);
    ...
    CircleImageView(Context context, int i2) {
        ...
        ViewCompat.m0(this, shapeDrawable);
    }
