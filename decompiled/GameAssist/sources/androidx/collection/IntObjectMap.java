...
public abstract class IntObjectMap<V> {
    ...
    public final boolean a(int i2) {
        ...
        while (true) {
            ...
            for (long j4 = (~j3) & (j3 - 72340172838076673L) & (-9187201950435737472L); j4 != 0; j4 &= j4 - 1) {
                ...
                if (this.f1247b[numberOfTrailingZeros] == i2) {
    ...
    */
    public final java.lang.Object b(int r14) {
        ...
        L63:
            if (r10 < 0) goto L6a
            java.lang.Object[] r13 = r13.f1248c
            r13 = r13[r10]
            goto L6b
        L6a:
            r13 = 0
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((255 & j2) < 128) {
                            ...
                            if (obj2 == null) {
                                if (intObjectMap.b(i6) != null || !intObjectMap.a(i6)) {
                                    break loop0;
                                }
                            } else if (!Intrinsics.a(obj2, intObjectMap.b(i6))) {
                                return false;
                            }
                        }
                        j2 >>= 8;
    ...
    private IntObjectMap() {
        this.f1246a = ScatterMapKt.f1393a;
        this.f1247b = IntSetKt.a();
        this.f1248c = ContainerHelpersKt.f1415c;
    }
}
