...
public abstract class FloatFloatMap {
    ...
    public final int a(float f2) {
        ...
        while (true) {
            ...
            for (long j4 = (~j3) & (j3 - 72340172838076673L) & (-9187201950435737472L); j4 != 0; j4 &= j4 - 1) {
                ...
                if (this.f1188b[numberOfTrailingZeros] == f2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (floatFloatMap.d() != d()) {
            return false;
        }
        float[] fArr = this.f1188b;
        float[] fArr2 = this.f1189c;
        long[] jArr = this.f1187a;
            ...
            while (true) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((255 & j2) < 128) {
                            int i5 = (i2 << 3) + i4;
                            if (fArr2[i5] != floatFloatMap.b(fArr[i5])) {
                                return false;
                            }
                        }
                        j2 >>= 8;
    ...
    private FloatFloatMap() {
        this.f1187a = ScatterMapKt.f1393a;
        this.f1188b = FloatSetKt.a();
        this.f1189c = FloatSetKt.a();
    }
}
