...
public abstract class IntList {
    ...
    public static /* synthetic */ String b(IntList intList, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, int i3, Object obj) {
        ...
        return intList.a(charSequence, charSequence5, charSequence6, i4, charSequence4);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof IntList) {
            ...
            int i2 = intList.f1238b;
            int i3 = this.f1238b;
            if (i2 == i3) {
                int[] iArr = this.f1237a;
                int[] iArr2 = intList.f1237a;
    ...
    private IntList(int i2) {
        this.f1237a = i2 == 0 ? IntSetKt.a() : new int[i2];
    }
}
