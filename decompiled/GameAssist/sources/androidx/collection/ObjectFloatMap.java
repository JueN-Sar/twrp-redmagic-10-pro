...
public abstract class ObjectFloatMap<K> {
    ...
    public final int a(Object obj) {
        ...
        while (true) {
            ...
            for (long j4 = (~j3) & (j3 - 72340172838076673L) & (-9187201950435737472L); j4 != 0; j4 &= j4 - 1) {
                ...
                if (Intrinsics.a(this.f1363b[numberOfTrailingZeros], obj)) {
    ...
    public boolean equals(Object obj) {
        ...
        if (objectFloatMap.d() != d()) {
            return false;
        }
        Object[] objArr = this.f1363b;
        float[] fArr = this.f1364c;
        long[] jArr = this.f1362a;
            ...
            while (true) {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((255 & j2) < 128) {
                            int i5 = (i2 << 3) + i4;
                            if (fArr[i5] != objectFloatMap.b(objArr[i5])) {
                                return false;
                            }
                        }
                        j2 >>= 8;
    ...
    private ObjectFloatMap() {
        this.f1362a = ScatterMapKt.f1393a;
        this.f1363b = ContainerHelpersKt.f1415c;
        this.f1364c = FloatSetKt.a();
    }
}
