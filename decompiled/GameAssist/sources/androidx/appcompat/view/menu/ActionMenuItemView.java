...
public class ActionMenuItemView extends AppCompatTextView implements MenuView.ItemView, View.OnClickListener, ActionMenuView.ActionMenuChildView {
    ...
    private class ActionMenuItemForwardingListener extends ForwardingListener {
        ...
        protected boolean c() {
            ...
            return itemInvoker != null && itemInvoker.b(actionMenuItemView.mItemData) && (b2 = b()) != null && b2.isShowing();
        }
    }
    ...
    private void t() {
        ...
        if (this.mIcon != null && (!this.mItemData.A() || (!this.mAllowTextWithIcon && !this.mExpandedFormat))) {
            z = false;
        }
        boolean z3 = z2 & z;
        ...
        if (TextUtils.isEmpty(tooltipText)) {
            TooltipCompat.a(this, z3 ? null : this.mItemData.getTitle());
        } else {
    ...
    @Override // androidx.appcompat.widget.ActionMenuView.ActionMenuChildView
    public boolean b() {
        return r() && this.mItemData.getIcon() == null;
    }
    ...
    protected void onMeasure(int i2, int i3) {
        int i4;
        boolean r2 = r();
        if (r2 && (i4 = this.mSavedPaddingLeft) >= 0) {
        ...
        if (mode != 1073741824 && this.mMinWidth > 0 && measuredWidth < min) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(min, WindowManagerWrapper.LayoutParams.PRIVATE_FLAG_INSET_PARENT_FRAME_BY_IME), i3);
        }
        if (r2 || this.mIcon == null) {
            return;
        }
