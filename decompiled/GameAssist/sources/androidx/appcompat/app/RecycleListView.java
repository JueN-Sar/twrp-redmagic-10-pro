...
public class RecycleListView extends AlertController.RecycleListView implements ISpringView {
    private static final String TAG = "Z#View-RecycleListViewX";
    ...
    protected void onFinishInflate() {
        ...
        if (this.mIsUseSpring) {
            setOnScrollListener(new AbsListView.OnScrollListener() { // from class: androidx.appcompat.app.RecycleListView.1

                /* renamed from: a, reason: collision with root package name */
                private SparseArray f294a = new SparseArray(0);

                /* renamed from: b, reason: collision with root package name */
                private int f295b = 0;

                /* renamed from: androidx.appcompat.app.RecycleListView$1$ItemRecod */
                class ItemRecod {
                ...
                private int a() {
                    ...
                    while (true) {
                        ...
                        ItemRecod itemRecod = (ItemRecod) this.f294a.get(i3);
                        if (itemRecod != null) {
                            i4 += itemRecod.f297a;
                        }
                        i3++;
                    }
                    ItemRecod itemRecod2 = (ItemRecod) this.f294a.get(i2);
                    if (itemRecod2 == null) {
                        itemRecod2 = new ItemRecod(this);
                    }
                    return i4 - itemRecod2.f298b;
                }
                ...
                public void onScroll(AbsListView absListView, int i2, int i3, int i4) {
                    ...
                    if (childAt != null) {
                        ItemRecod itemRecod = (ItemRecod) this.f294a.get(i2);
                        if (itemRecod == null) {
                            itemRecod = new ItemRecod(this);
                        }
                        itemRecod.f297a = childAt.getHeight();
                        itemRecod.f298b = childAt.getTop();
                        this.f294a.append(i2, itemRecod);
                        if (itemRecod.f297a != 0) {
                            RecycleListView.this.mTotalyDy -= a() / childAt.getHeight();
