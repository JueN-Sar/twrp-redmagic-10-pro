...
public class AppCompatImageView extends ImageView implements TintableBackgroundView, TintableImageSourceView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatImageView> {
        ...
        public void readProperties(AppCompatImageView appCompatImageView, PropertyReader propertyReader) {
            ...
            propertyReader.readObject(this.f776b, appCompatImageView.getBackgroundTintList());
            propertyReader.readObject(this.f777c, appCompatImageView.getBackgroundTintMode());
            propertyReader.readObject(this.f778d, appCompatImageView.getImageTintList());
            propertyReader.readObject(this.f779e, appCompatImageView.getImageTintMode());
        }

        @Override // android.view.inspector.InspectionCompanion
        public void mapProperties(PropertyMapper propertyMapper) {
            this.f776b = propertyMapper.mapObject("backgroundTint", R.attr.backgroundTint);
            this.f777c = propertyMapper.mapObject("backgroundTintMode", R.attr.backgroundTintMode);
            this.f778d = propertyMapper.mapObject("tint", R.attr.tint);
            this.f779e = propertyMapper.mapObject("tintMode", R.attr.tintMode);
            this.f775a = true;
        }
    }
