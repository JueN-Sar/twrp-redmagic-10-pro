...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    static int K(View view, int i2, int i3, int i4, int i5) {
        int i6;
        ...
        if (i3 > 0) {
            ...
            if (!z2 || i3 >= 2) {
                ...
                if (!layoutParams.f657a && z2) {
                    z = true;
                }
                layoutParams.f660d = z;
                layoutParams.f658b = i6;
                view.measure(View.MeasureSpec.makeMeasureSpec(i2 * i6, WindowManagerWrapper.LayoutParams.PRIVATE_FLAG_INSET_PARENT_FRAME_BY_IME), makeMeasureSpec);
                return i6;
            }
        }
        i6 = 0;
    ...
    private void L(int i2, int i3) {
        ...
        while (i15 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                layoutParams.f662f = r14;
                layoutParams.f659c = r14;
                layoutParams.f658b = r14;
                layoutParams.f660d = r14;
                ((LinearLayout.LayoutParams) layoutParams).leftMargin = r14;
                ((LinearLayout.LayoutParams) layoutParams).rightMargin = r14;
                layoutParams.f661e = z5 && ((ActionMenuItemView) childAt).r();
                int K = K(childAt, i13, layoutParams.f657a ? 1 : i11, childMeasureSpec, paddingTop);
                i17 = Math.max(i17, K);
                if (layoutParams.f660d) {
                    i18++;
                }
                if (layoutParams.f657a) {
                    z4 = true;
        ...
        while (i18 > 0 && i11 > 0) {
            ...
            while (i25 < childCount) {
                ...
                int i26 = i14;
                if (layoutParams2.f660d) {
                    int i27 = layoutParams2.f658b;
                    if (i27 < i23) {
                        j3 = 1 << i25;
                        i23 = i27;
                        i24 = 1;
            ...
            while (i29 < childCount) {
                ...
                long j4 = 1 << i29;
                if ((j3 & j4) == 0) {
                    if (layoutParams3.f658b == i28) {
                        j2 |= j4;
                    }
                    z3 = z6;
                } else {
                    if (z6 && layoutParams3.f661e && i11 == 1) {
        ...
        if (i11 <= 0 || j2 == 0 || (i11 >= i16 - 1 && !z9 && i17 <= 1)) {
            ...
            if (z9) {
                ...
                i7 = 0;
                if ((j2 & 1) != 0 && !((LayoutParams) getChildAt(0).getLayoutParams()).f661e) {
                    bitCount -= 0.5f;
                }
                int i33 = childCount - 1;
                if ((j2 & (1 << i33)) != 0 && !((LayoutParams) getChildAt(i33).getLayoutParams()).f661e) {
                    bitCount -= 0.5f;
                }
            }
            ...
            for (int i35 = i7; i35 < childCount; i35++) {
                if ((j2 & (1 << i35)) != 0) {
                    ...
                    if (childAt3 instanceof ActionMenuItemView) {
                        layoutParams4.f659c = i34;
                        layoutParams4.f662f = true;
                        if (i35 == 0 && !layoutParams4.f661e) {
                            ((LinearLayout.LayoutParams) layoutParams4).leftMargin = (-i34) / 2;
                        }
                        z2 = true;
                    } else if (layoutParams4.f657a) {
                        layoutParams4.f659c = i34;
                        layoutParams4.f662f = true;
        ...
        if (z2) {
            for (int i36 = i7; i36 < childCount; i36++) {
                ...
                if (layoutParams5.f662f) {
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((layoutParams5.f658b * i13) + layoutParams5.f659c, WindowManagerWrapper.LayoutParams.PRIVATE_FLAG_INSET_PARENT_FRAME_BY_IME), childMeasureSpec);
                }
            }
        }
    ...
    public LayoutParams E() {
        ...
        generateDefaultLayoutParams.f657a = true;
        return generateDefaultLayoutParams;
    }
    ...
    protected boolean F(int i2) {
        ...
        return (i2 <= 0 || !(childAt2 instanceof ActionMenuChildView)) ? z : z | ((ActionMenuChildView) childAt2).b();
    }
    ...
    public Menu getMenu() {
        if (this.mMenu == null) {
            ...
            this.mMenu = menuBuilder;
            menuBuilder.W(new MenuBuilderCallback());
    ...
    protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (b2) {
            ...
            for (int i16 = 0; i16 < childCount; i16++) {
                ...
                if (childAt3.getVisibility() != 8 && !layoutParams2.f657a) {
        ...
        for (int i19 = 0; i19 < childCount; i19++) {
            ...
            if (childAt4.getVisibility() != 8 && !layoutParams3.f657a) {
