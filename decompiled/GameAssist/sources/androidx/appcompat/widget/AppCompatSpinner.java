...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
        ...
        public void show(int i2, int i3) {
            ...
            AlertDialog a2 = builder.k(this.mListAdapter, AppCompatSpinner.this.getSelectedItemPosition(), this).a();
            this.mPopup = a2;
            ListView l2 = a2.l();
    ...
    private static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        private SpinnerAdapter f806c;

        /* renamed from: h, reason: collision with root package name */
        private ListAdapter f807h;

        public DropDownAdapter(SpinnerAdapter spinnerAdapter, Resources.Theme theme) {
            this.f806c = spinnerAdapter;
            if (spinnerAdapter instanceof ListAdapter) {
                this.f807h = (ListAdapter) spinnerAdapter;
            }
            if (theme != null) {
        ...
        public boolean areAllItemsEnabled() {
            ListAdapter listAdapter = this.f807h;
            if (listAdapter != null) {
        ...
        public int getCount() {
            SpinnerAdapter spinnerAdapter = this.f806c;
    ...
    class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        void computeContentWidth() {
            ...
            if (background != null) {
                ...
                i2 = ViewUtils.b(AppCompatSpinner.this) ? AppCompatSpinner.this.mTempRect.right : -AppCompatSpinner.this.mTempRect.left;
            } else {
            ...
            if (i3 == -2) {
                int a2 = appCompatSpinner.a((SpinnerAdapter) this.mAdapter, getBackground());
            ...
            setHorizontalOffset(ViewUtils.b(AppCompatSpinner.this) ? i2 + (((width - paddingRight) - getWidth()) - getHorizontalOriginalOffset()) : i2 + paddingLeft + getHorizontalOriginalOffset());
        }
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatSpinner> {
        ...
        public void readProperties(AppCompatSpinner appCompatSpinner, PropertyReader propertyReader) {
            ...
            propertyReader.readObject(this.f814b, appCompatSpinner.getBackgroundTintList());
            propertyReader.readObject(this.f815c, appCompatSpinner.getBackgroundTintMode());
        }

        @Override // android.view.inspector.InspectionCompanion
        public void mapProperties(PropertyMapper propertyMapper) {
            this.f814b = propertyMapper.mapObject("backgroundTint", androidx.appcompat.R.attr.backgroundTint);
            this.f815c = propertyMapper.mapObject("backgroundTintMode", androidx.appcompat.R.attr.backgroundTintMode);
            this.f813a = true;
        }
    }
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeByte(this.f816c ? (byte) 1 : (byte) 0);
        }

        SavedState(Parcel parcel) {
            super(parcel);
            this.f816c = parcel.readByte() != 0;
        }
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (!savedState.f816c || (viewTreeObserver = getViewTreeObserver()) == null) {
            return;
        }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        SpinnerPopup spinnerPopup = this.mPopup;
        savedState.f816c = spinnerPopup != null && spinnerPopup.isShowing();
        return savedState;
    }
