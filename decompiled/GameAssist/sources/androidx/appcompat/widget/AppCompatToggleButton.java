...
public class AppCompatToggleButton extends ToggleButton implements TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatToggleButton> {
        ...
        public void readProperties(AppCompatToggleButton appCompatToggleButton, PropertyReader propertyReader) {
            ...
            propertyReader.readObject(this.f866b, appCompatToggleButton.getBackgroundTintList());
            propertyReader.readObject(this.f867c, appCompatToggleButton.getBackgroundTintMode());
            propertyReader.readObject(this.f868d, appCompatToggleButton.getCompoundDrawableTintList());
            propertyReader.readObject(this.f869e, appCompatToggleButton.getCompoundDrawableTintMode());
        }

        @Override // android.view.inspector.InspectionCompanion
        public void mapProperties(PropertyMapper propertyMapper) {
            this.f866b = propertyMapper.mapObject("backgroundTint", R.attr.backgroundTint);
            this.f867c = propertyMapper.mapObject("backgroundTintMode", R.attr.backgroundTintMode);
            this.f868d = propertyMapper.mapObject("drawableTint", R.attr.drawableTint);
            this.f869e = propertyMapper.mapObject("drawableTintMode", R.attr.drawableTintMode);
            this.f865a = true;
        }
    }
