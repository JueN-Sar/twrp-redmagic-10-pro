...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onMeasure(int i2, int i3) {
        ...
        setMeasuredDimension(getMeasuredWidth(), Math.min((!b(this.mActionBarView) ? a(this.mActionBarView) : !b(this.mContextView) ? a(this.mContextView) : 0) + a(this.mTabContainer), mode == Integer.MIN_VALUE ? View.MeasureSpec.getSize(i3) : Api.BaseClientBuilder.API_PRIORITY_OTHER));
    }
    ...
    public void setTransitioning(boolean z) {
        ...
        setDescendantFocusability(z ? 393216 : WindowManagerWrapper.LayoutParams.PRIVATE_FLAG_OVERRIDE_LAYOUT_IN_DISPLAY_CUTOUT_MODE);
    }
