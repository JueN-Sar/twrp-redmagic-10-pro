...
public class VectorEnabledTintResources extends ResourcesWrapper {
    ...
    private static boolean f1093c = false;

    /* renamed from: b, reason: collision with root package name */
    private final WeakReference f1094b;

    public VectorEnabledTintResources(Context context, Resources resources) {
        super(resources);
        this.f1094b = new WeakReference(context);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ void getValueForDensity(int i2, int i3, TypedValue typedValue, boolean z) {
    ...
    public Drawable getDrawable(int i2) {
        Context context = (Context) this.f1094b.get();
        return context != null ? ResourceManagerInternal.g().s(context, this, i2) : a(i2);
    }
