...
public class CardView extends FrameLayout {
    ...
    protected void onMeasure(int i2, int i3) {
        ...
        if (mode == Integer.MIN_VALUE || mode == 1073741824) {
            i2 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil(r0.m(this.mCardViewDelegate)), View.MeasureSpec.getSize(i2)), mode);
        }
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        IMPL.h(cardViewDelegate, context, colorStateList, dimension, dimension2, f2);
    }
