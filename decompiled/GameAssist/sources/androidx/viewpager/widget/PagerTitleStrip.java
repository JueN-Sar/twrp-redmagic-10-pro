...
public class PagerTitleStrip extends ViewGroup {
    ...
    private class PageListener extends DataSetObserver implements ViewPager.OnPageChangeListener, ViewPager.OnAdapterChangeListener {
        ...
        public void g(int i2) {
            if (this.f5754c == 0) {
                ...
                pagerTitleStrip2.d(pagerTitleStrip2.mPager.getCurrentItem(), f2, true);
            }
        }
    ...
    private static class SingleLineAllCapsTransform extends SingleLineTransformationMethod {
        ...
        /* renamed from: c, reason: collision with root package name */
        private Locale f5756c;

        SingleLineAllCapsTransform(Context context) {
            this.f5756c = context.getResources().getConfiguration().locale;
        }
        ...
        public CharSequence getTransformation(CharSequence charSequence, View view) {
            ...
            if (transformation != null) {
                return transformation.toString().toUpperCase(this.f5756c);
            }
            return null;
        }
    }
    ...
    public PagerTitleStrip(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        if (resourceId != 0) {
            TextViewCompat.p(this.mPrevText, resourceId);
            TextViewCompat.p(this.mCurrText, resourceId);
            TextViewCompat.p(this.mNextText, resourceId);
        }
    ...
    void b(PagerAdapter pagerAdapter, PagerAdapter pagerAdapter2) {
        if (pagerAdapter != null) {
            pagerAdapter.u(this.mPageListener);
            this.mWatchingAdapter = null;
        }
        if (pagerAdapter2 != null) {
            pagerAdapter2.m(this.mPageListener);
    ...
    void c(int i2, PagerAdapter pagerAdapter) {
        int e2 = pagerAdapter != null ? pagerAdapter.e() : 0;
        this.mUpdatingText = true;
        CharSequence charSequence = null;
        this.mPrevText.setText((i2 < 1 || pagerAdapter == null) ? null : pagerAdapter.g(i2 - 1));
        this.mCurrText.setText((pagerAdapter == null || i2 >= e2) ? null : pagerAdapter.g(i2));
        int i3 = i2 + 1;
        ...
        if (!this.mUpdatingPositions) {
            d(i2, this.mLastKnownPositionOffset, false);
        }
    ...
    protected void onAttachedToWindow() {
        ...
        viewPager.Q(this.mPageListener);
        viewPager.b(this.mPageListener);
    ...
    protected void onDetachedFromWindow() {
        ...
        if (viewPager != null) {
            ...
            this.mPager.Q(null);
            this.mPager.I(this.mPageListener);
            this.mPager = null;
        }
    }
    ...
    protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        if (this.mPager != null) {
            ...
            d(this.mLastKnownCurrentPage, f2, true);
        }
    }
