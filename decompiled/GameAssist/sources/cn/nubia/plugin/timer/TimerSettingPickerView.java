...
public class TimerSettingPickerView extends View {
    ...
    public interface OnScrollListener {
        ...
        void a(TimerSettingPickerView timerSettingPickerView, int i2);
    }

    public interface OnValueChangeListener {
        void a(TimerSettingPickerView timerSettingPickerView, int i2, int i3);
    }
    ...
    private static class TwoDigitFormatter implements Formatter {
        ...
        java.util.Formatter f8758c;

        /* renamed from: a, reason: collision with root package name */
        final StringBuilder f8756a = new StringBuilder();

        /* renamed from: d, reason: collision with root package name */
        final Object[] f8759d = new Object[1];
        ...
        private java.util.Formatter b(Locale locale) {
            return new java.util.Formatter(this.f8756a, locale);
        }
        ...
        private void d(Locale locale) {
            this.f8758c = b(locale);
            this.f8757b = c(locale);
        }

        @Override // cn.nubia.plugin.timer.TimerSettingPickerView.Formatter
        public String a(int i2) {
            Locale locale = Locale.getDefault();
            if (this.f8757b != c(locale)) {
                d(locale);
            }
            this.f8759d[0] = Integer.valueOf(i2);
            StringBuilder sb = this.f8756a;
            sb.delete(0, sb.length());
            this.f8758c.format("%02d", this.f8759d);
            return this.f8758c.toString();
        }
    }

    public TimerSettingPickerView(Context context, AttributeSet attributeSet) {
        ...
        this.mSelectedWheelPaint.setColor(-1);
        this.mSelectedWheelPaint.setAntiAlias(true);
        this.mSelectedWheelPaint.setTextAlign(Paint.Align.LEFT);
        this.mTextSize = getResources().getDimensionPixelSize(R.dimen.plugin_timer_setting_pickview_text_size);
        this.mAdjustDrawPos = 9;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i2 = 0; i2 < iArr.length; i2++) {
            ...
            Rect rect = this.mTextShowRect;
            Rect rect2 = this.mTextBound;
            rect.left = (int) (rect2.left + right);
            int i4 = (int) ((rect2.top * f4) + f5);
            rect.top = i4;
            rect.right = (int) (rect2.right + right);
            int i5 = (int) ((rect2.bottom * f4) + f5);
            rect.bottom = i5;
            float f6 = i5;
            int i6 = this.mMiddleTop;
            if (f6 <= i6 * f4 || i4 >= (this.mMiddleBottom * f4) - 10.0f) {
                canvas.drawText(str, right - 4.0f, f5, this.mSelectedWheelPaint);
            } else {
                canvas.clipRect(0.0f, (i6 * f4) + 1.0f, getWidth(), this.mMiddleBottom * this.mTextsScaleX[i2]);
                ...
                canvas.drawText(str, this.mCurrentLocationX - 4.0f, this.mCurrentLocationY, this.mSelectedWheelPaint);
            }
            canvas.restore();
        }
    }
    ...
    protected void onMeasure(int i2, int i3) {
        super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(getResources().getDimensionPixelSize(R.dimen.plugin_timer_setting_pickview_height), WindowManagerWrapper.LayoutParams.PRIVATE_FLAG_INSET_PARENT_FRAME_BY_IME));
    }
