...
public final class PlatformImplementationsKt {
    ...
    public static final PlatformImplementations f18428a;
    ...
    static {
        ...
        try {
            ...
            Intrinsics.d(newInstance, "forName(\"kotlin.internal…entations\").newInstance()");
            try {
                try {
                } catch (ClassNotFoundException unused) {
                    Object newInstance2 = JDK7PlatformImplementations.class.newInstance();
                    Intrinsics.d(newInstance2, "forName(\"kotlin.internal…entations\").newInstance()");
                    try {
                        try {
            ...
            Intrinsics.d(newInstance3, "forName(\"kotlin.internal…entations\").newInstance()");
            try {
                try {
                ...
                Intrinsics.d(newInstance4, "forName(\"kotlin.internal…entations\").newInstance()");
                try {
        ...
        f18428a = platformImplementations;
    }
}
