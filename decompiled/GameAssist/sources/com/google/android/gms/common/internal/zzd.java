...
public final class zzd extends zzac {
    ...
    public final void onPostInitComplete(int i2, @NonNull IBinder iBinder, @Nullable Bundle bundle) {
        Preconditions.j(this.zza, "onPostInitComplete can be called only once per call to getRemoteService");
        this.zza.O(i2, iBinder, bundle, this.zzb);
        this.zza = null;
    }
    ...
    public final void zzc(int i2, @NonNull IBinder iBinder, @NonNull zzk zzkVar) {
        ...
        onPostInitComplete(i2, iBinder, zzkVar.f11105c);
    }
}
