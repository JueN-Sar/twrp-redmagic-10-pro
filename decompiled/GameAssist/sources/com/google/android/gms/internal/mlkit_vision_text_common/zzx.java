...
public final class zzx {
    public static int a(int i2, int i3, String str) {
        ...
        if (i2 < 0) {
            a2 = zzy.a("%s (%s) must not be negative", VirtualHandleWrapper.KEY_INDEX, Integer.valueOf(i2));
        } else {
            if (i3 < 0) {
                throw new IllegalArgumentException("negative size: " + i3);
            }
            a2 = zzy.a("%s (%s) must be less than size (%s)", VirtualHandleWrapper.KEY_INDEX, Integer.valueOf(i2), Integer.valueOf(i3));
        }
    ...
    public static void c(int i2, int i3, int i4) {
        if (i2 < 0 || i3 < i2 || i3 > i4) {
            throw new IndexOutOfBoundsException((i2 < 0 || i2 > i4) ? e(i2, i4, "start index") : (i3 < 0 || i3 > i4) ? e(i3, i4, "end index") : zzy.a("end index (%s) must not be less than start index (%s)", Integer.valueOf(i3), Integer.valueOf(i2)));
        }
    }
