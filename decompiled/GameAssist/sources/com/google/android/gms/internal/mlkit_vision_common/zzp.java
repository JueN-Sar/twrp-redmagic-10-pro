...
public abstract class zzp extends zzl implements List, RandomAccess {
    ...
    static zzp j(Object[] objArr) {
        return k(objArr, objArr.length);
    }

    static zzp k(Object[] objArr, int i2) {
        return i2 == 0 ? zzu.zza : new zzu(objArr, i2);
    }

    public static zzp l(Object obj) {
        Object[] objArr = {obj};
        zzt.a(objArr, 1);
        return k(objArr, 1);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof List) {
            ...
            if (size == list.size()) {
                ...
                while (true) {
                    if (it.hasNext()) {
                        if (!it2.hasNext() || !zzb.a(it.next(), it2.next())) {
                            break;
                        }
                    } else if (!it2.hasNext()) {
                        return true;
    ...
    public final zzac listIterator(int i2) {
        zzf.b(i2, size(), VirtualHandleWrapper.KEY_INDEX);
