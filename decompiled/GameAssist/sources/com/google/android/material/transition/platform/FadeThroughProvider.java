...
public final class FadeThroughProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator c(final View view, final float f2, final float f3, final float f4, final float f5, final float f6) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.transition.platform.FadeThroughProvider.1
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                view.setAlpha(TransitionUtils.n(f2, f3, f4, f5, ((Float) valueAnimator.getAnimatedValue()).floatValue()));
            }
        });
    ...
    public Animator a(ViewGroup viewGroup, View view) {
        ...
        return c(view, alpha, 0.0f, 0.0f, this.f15662a, alpha);
    }

    @Override // com.google.android.material.transition.platform.VisibilityAnimatorProvider
    public Animator b(ViewGroup viewGroup, View view) {
        float alpha = view.getAlpha() == 0.0f ? 1.0f : view.getAlpha();
        return c(view, 0.0f, alpha, this.f15662a, 1.0f, alpha);
    }
}
