...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    public int getContentPaddingBottom() {
        return this.cardViewHelper.C().bottom;
    }

    @Override // androidx.cardview.widget.CardView
    public int getContentPaddingLeft() {
        return this.cardViewHelper.C().left;
    }

    @Override // androidx.cardview.widget.CardView
    public int getContentPaddingRight() {
        return this.cardViewHelper.C().right;
    }

    @Override // androidx.cardview.widget.CardView
    public int getContentPaddingTop() {
        return this.cardViewHelper.C().top;
    }
    ...
    protected void onAttachedToWindow() {
        ...
        MaterialShapeUtils.f(this, this.cardViewHelper.l());
    }
    ...
    public void setCardBackgroundColor(@ColorInt int i2) {
        this.cardViewHelper.M(ColorStateList.valueOf(i2));
    }

    @Override // androidx.cardview.widget.CardView
    public void setCardElevation(float f2) {
        super.setCardElevation(f2);
        this.cardViewHelper.i0();
    }
    ...
    public void setCheckedIconGravity(int i2) {
        if (this.cardViewHelper.p() != i2) {
            this.cardViewHelper.S(i2);
        }
    }
    ...
    public void setCheckedIconMarginResource(@DimenRes int i2) {
        if (i2 != -1) {
            this.cardViewHelper.T(getResources().getDimensionPixelSize(i2));
        }
    }

    public void setCheckedIconResource(@DrawableRes int i2) {
        this.cardViewHelper.R(AppCompatResources.b(getContext(), i2));
    }

    public void setCheckedIconSize(@Dimension int i2) {
        this.cardViewHelper.U(i2);
    }

    public void setCheckedIconSizeResource(@DimenRes int i2) {
        if (i2 != 0) {
            this.cardViewHelper.U(getResources().getDimensionPixelSize(i2));
        }
    }
    ...
    public void setProgress(@FloatRange float f2) {
        this.cardViewHelper.X(f2);
    }

    @Override // androidx.cardview.widget.CardView
    public void setRadius(float f2) {
        super.setRadius(f2);
        this.cardViewHelper.W(f2);
    }
    ...
    public void setRippleColorResource(@ColorRes int i2) {
        this.cardViewHelper.Y(AppCompatResources.a(getContext(), i2));
    }
