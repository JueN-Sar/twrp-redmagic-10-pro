...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    static class SavedState extends AbsSavedState {
        ...
        private void b(Parcel parcel) {
            this.f14691i = parcel.readInt() == 1;
        }

        @Override // androidx.customview.view.AbsSavedState, android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i2) {
            super.writeToParcel(parcel, i2);
            parcel.writeInt(this.f14691i ? 1 : 0);
        }
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        setChecked(savedState.f14691i);
    }

    @Override // android.view.View
    protected Parcelable onSaveInstanceState() {
        SavedState savedState = new SavedState(super.onSaveInstanceState());
        savedState.f14691i = this.checked;
        return savedState;
    }
    ...
    public CheckableImageButton(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.checkable = true;
        this.pressable = true;
        ViewCompat.i0(this, new AccessibilityDelegateCompat() { // from class: com.google.android.material.internal.CheckableImageButton.1
            ...
            public void g(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                accessibilityNodeInfoCompat.f0(CheckableImageButton.this.a());
                accessibilityNodeInfoCompat.g0(CheckableImageButton.this.isChecked());
            }
        });
    }
}
