...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public ForegroundLinearLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        this.foregroundBoundsChanged = false;
        TypedArray i3 = ThemeEnforcement.i(context, attributeSet, R.styleable.ForegroundLinearLayout, i2, 0, new int[0]);
        this.foregroundGravity = i3.getInt(R.styleable.ForegroundLinearLayout_android_foregroundGravity, this.foregroundGravity);
        Drawable drawable = i3.getDrawable(R.styleable.ForegroundLinearLayout_android_foreground);
        if (drawable != null) {
            setForeground(drawable);
        }
        this.mForegroundInPadding = i3.getBoolean(R.styleable.ForegroundLinearLayout_foregroundInsidePadding, true);
        i3.recycle();
    }
}
