...
public class ToolbarUtils {
    ...
    private static final Comparator f14791a = new Comparator<View>() { // from class: com.google.android.material.internal.ToolbarUtils.1
    ...
    public static TextView f(Toolbar toolbar) {
        List g2 = g(toolbar, toolbar.getSubtitle());
        if (g2.isEmpty()) {
            return null;
        }
        return (TextView) Collections.max(g2, f14791a);
    }

    private static List g(Toolbar toolbar, CharSequence charSequence) {
    ...
    public static TextView h(Toolbar toolbar) {
        List g2 = g(toolbar, toolbar.getTitle());
        if (g2.isEmpty()) {
            return null;
        }
        return (TextView) Collections.min(g2, f14791a);
    }
}
