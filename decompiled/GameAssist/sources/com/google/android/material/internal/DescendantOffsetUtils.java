...
public class DescendantOffsetUtils {
    ...
    private static final ThreadLocal f14713a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f14714b = new ThreadLocal();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f14713a;
        ...
        ThreadLocal threadLocal2 = f14714b;
