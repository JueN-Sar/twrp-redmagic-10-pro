...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    public ScrimInsetsFrameLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray i3 = ThemeEnforcement.i(context, attributeSet, R.styleable.ScrimInsetsFrameLayout, i2, R.style.Widget_Design_ScrimInsetsFrameLayout, new int[0]);
        this.insetForeground = i3.getDrawable(R.styleable.ScrimInsetsFrameLayout_insetForeground);
        i3.recycle();
        setWillNotDraw(true);
        ViewCompat.x0(this, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.internal.ScrimInsetsFrameLayout.1
