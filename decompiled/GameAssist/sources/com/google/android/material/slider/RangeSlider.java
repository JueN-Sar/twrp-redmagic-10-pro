...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public interface OnChangeListener extends BaseOnChangeListener<RangeSlider> {
        ...
        void a(RangeSlider rangeSlider, float f2, boolean z);
    }
    ...
    static class RangeSliderState extends AbsSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeFloat(this.f15283c);
    ...
    private static List G0(TypedArray typedArray) {
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.minSeparation = rangeSliderState.f15283c;
        int i2 = rangeSliderState.f15284h;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        rangeSliderState.f15283c = this.minSeparation;
        rangeSliderState.f15284h = this.separationUnit;
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray i3 = ThemeEnforcement.i(context, attributeSet, R.styleable.RangeSlider, i2, BaseSlider.DEF_STYLE_RES, new int[0]);
        if (i3.hasValue(R.styleable.RangeSlider_values)) {
            setValues(G0(i3.getResources().obtainTypedArray(i3.getResourceId(R.styleable.RangeSlider_values, 0))));
        }
        this.minSeparation = i3.getDimension(R.styleable.RangeSlider_minSeparation, 0.0f);
        i3.recycle();
    }
