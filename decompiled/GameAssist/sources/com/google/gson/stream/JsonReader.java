    ...
    */
    ...
    public double nextDouble() {
        ...
        if (i2 == 16) {
            ...
            this.peekedString = nextQuotedValue(i2 == 8 ? NubiaTextClock.QUOTE : '\"');
        } else if (i2 == 10) {
    ...
    public String nextName() {
        ...
        if (i2 == 14) {
            ...
            nextQuotedValue = nextQuotedValue(NubiaTextClock.QUOTE);
        } else {
            if (i2 != 13) {
    ...
    public String nextString() {
        ...
        if (i2 == 10) {
            ...
            str = nextQuotedValue(NubiaTextClock.QUOTE);
        } else if (i2 == 9) {
            str = nextQuotedValue('\"');
        } else if (i2 == 11) {
            ...
            if (i3 == 3) {
                ...
                if (i3 == 4) {
                    ...
                    if (i3 == 14 || i3 == 10) {
                        ...
                        skipQuotedValue(NubiaTextClock.QUOTE);
                    } else if (i3 == 9 || i3 == 13) {
                        skipQuotedValue('\"');
                    } else if (i3 == 16) {
                        this.pos += this.peekedNumberLength;
