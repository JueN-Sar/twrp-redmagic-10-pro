...
@Metadata
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$delayFlow$1", f = "Migration.kt", l = {415}, m = "invokeSuspend")
...
final class FlowKt__MigrationKt$delayFlow$1 extends SuspendLambda implements Function2<FlowCollector<Object>, Continuation<? super Unit>, Object> {
    ...
    public final Object y(FlowCollector flowCollector, Continuation continuation) {
        return ((FlowKt__MigrationKt$delayFlow$1) o(flowCollector, continuation)).v(Unit.f18288a);
    }
